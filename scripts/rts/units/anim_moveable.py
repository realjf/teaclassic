...
class AnimMoveable(tc.AnimEntity, tc.MovableEntity, cont.Controllable):
    """
    ...
    def __init__(self, path, tcobj, name, **kwargs):
        super(AnimMoveable, self).__init__(path, tcobj, name, **kwargs)
        self.moving = False
        self.register(tc.EVENT_MOTION_START,
                      AnimMoveable.__on_motion_begin, weakref.ref(self))
        self.register(tc.EVENT_MOTION_END,
                      AnimMoveable.__on_motion_end, weakref.ref(self))

    def __del__(self):
        self.unregister(tc.EVENT_MOTION_START, AnimMoveable.__on_motion_begin)
        self.unregister(tc.EVENT_MOTION_END, AnimMoveable.__on_motion_end)
