...
typedef struct {
  PyObject_HEAD struct entity *ent;
} PyEntityObject;

static PyObject *PyEntity_new(PyTypeObject *type, PyObject *args,
                              PyObject *kwds);
...
static int PyEntity_set_name(PyEntityObject *self, PyObject *value,
                             void *closure);
...
static int PyEntity_set_pos(PyEntityObject *self, PyObject *value,
                            void *closure);
static PyObject *PyEntity_get_scale(PyEntityObject *self, void *closure);
static int PyEntity_set_scale(PyEntityObject *self, PyObject *value,
                              void *closure);
static PyObject *PyEntity_get_rotation(PyEntityObject *self, void *closure);
static int PyEntity_set_rotation(PyEntityObject *self, PyObject *value,
                                 void *closure);
static PyObject *PyEntity_get_selectable(PyEntityObject *self, void *closure);
static int PyEntity_set_selectable(PyEntityObject *self, PyObject *value,
                                   void *closure);
static PyObject *PyEntity_get_selection_radius(PyEntityObject *self,
                                               void *closure);
static int PyEntity_set_selection_radius(PyEntityObject *self, PyObject *value,
                                         void *closure);
static PyObject *PyEntity_get_tcobj_path(PyEntityObject *self, void *closure);
static PyObject *PyEntity_get_top_screen_pos(PyEntityObject *self,
                                             void *closure);
static PyObject *PyEntity_get_faction_id(PyEntityObject *self, void *closure);
static int PyEntity_set_faction_id(PyEntityObject *self, PyObject *value,
                                   void *closure);
static PyObject *PyEntity_get_vision_range(PyEntityObject *self, void *closure);
static int PyEntity_set_vision_range(PyEntityObject *self, PyObject *value,
                                     void *closure);
...
static PyObject *PyEntity_pickle(PyEntityObject *self, PyObject *args,
                                 PyObject *kwargs);
static PyObject *PyEntity_unpickle(PyObject *cls, PyObject *args,
                                   PyObject *kwargs);

static PyMethodDef PyEntity_methods[] = {
    {"__del__", (PyCFunction)PyEntity_del, METH_NOARGS,
     "Calls the next __del__ in the MRO if there is one, otherwise do "
     "nothing."},

    {"register", (PyCFunction)PyEntity_register, METH_VARARGS,
     "Registers the specified callable to be invoked when an event of the "
     "specified type "
     "is sent to this entity."},

    {"unregister", (PyCFunction)PyEntity_unregister, METH_VARARGS,
     "Unregisters a callable previously registered to be invoked on the "
     "specified event."},

    {"notify", (PyCFunction)PyEntity_notify, METH_VARARGS,
     "Send a specific event to an entity in order to invoke the entity's event "
     "handlers. Weakref "
     "arguments are automatically unpacked before being passed to the "
     "handler."},

    {"select", (PyCFunction)PyEntity_select, METH_NOARGS,
     "Adds the entity to the current unit selection, if it is not present "
     "there already."},

    {"deselect", (PyCFunction)PyEntity_deselect, METH_NOARGS,
     "Removes the entity from the current unit selection, if it is selected."},

    {"stop", (PyCFunction)PyEntity_stop, METH_NOARGS,
     "Issues a 'stop' command to the entity, stopping its' movement and "
     "attack. Cancels 'hold position' order."},

    {"face_towards", (PyCFunction)PyEntity_face_towards, METH_VARARGS,
     "Make the entity face towards the specified point."},

    {"set_model", (PyCFunction)PyEntity_set_model, METH_VARARGS,
     "Replace the current entity's current model and animation data with the "
     "specified TCOBJ data."},

    {"ping", (PyCFunction)PyEntity_ping, METH_NOARGS,
     "Temporarily blink the enitity's selection circle."},

    {"zombiefy", (PyCFunction)PyEntity_zombiefy, METH_NOARGS,
     "Make the entity a 'zombie', effectively removing it from the game "
     "simulation but allowing "
     "the scripting object to persist."},

    {"add_tag", (PyCFunction)PyEntity_add_tag, METH_VARARGS,
     "Add a string tag to this entity's list of tags."},

    {"remove_tag", (PyCFunction)PyEntity_remove_tag, METH_VARARGS,
     "Remove a string tag from this entity's list of tags."},

    {"__pickle__", (PyCFunction)PyEntity_pickle, METH_KEYWORDS,
     "Serialize a Permafrost Engine entity to a string."},

    {"__unpickle__", (PyCFunction)PyEntity_unpickle,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS,
     "Create a new tc.Entity instance from a string earlier returned from a "
     "__pickle__ method."
...
static PyGetSetDef PyEntity_getset[] = {
    {"uid", (getter)PyEntity_get_uid, NULL,
     "The unique integer ID of this entity", NULL},
    {"name", (getter)PyEntity_get_name, (setter)PyEntity_set_name,
     "Custom name given to this enity.", NULL},
    {"zombie", (getter)PyEntity_get_zombie, NULL,
     "Returns True if the entity is a zombie (destroyed in the game "
     "simulation, but retained via a scripting reference).",
     NULL},
    {"height", (getter)PyEntity_get_height, NULL,
     "Returns the scaled height of the entity, in OpenGL coordinates.", NULL},
    {"pos", (getter)PyEntity_get_pos, (setter)PyEntity_set_pos,
     "The XYZ position in worldspace coordinates.", NULL},
    {"scale", (getter)PyEntity_get_scale, (setter)PyEntity_set_scale,
     "The XYZ scaling factors.", NULL},
    {"rotation", (getter)PyEntity_get_rotation, (setter)PyEntity_set_rotation,
     "XYZW quaternion for rotaion about local origin.", NULL},
    {"selectable", (getter)PyEntity_get_selectable,
     (setter)PyEntity_set_selectable,
     "Flag indicating whether this entity can be selected with the mouse.",
     NULL},
    {"selection_radius", (getter)PyEntity_get_selection_radius,
     (setter)PyEntity_set_selection_radius,
     "Radius (in OpenGL coordinates) of the unit selection circle for this "
     "entity.",
     NULL},
    {"tcobj_path", (getter)PyEntity_get_tcobj_path, NULL,
     "The relative path of the TCOBJ file used to instantiate the entity. "
     "Readonly.",
     NULL},
    {"top_screen_pos", (getter)PyEntity_get_top_screen_pos, NULL,
     "Get the location of the top center point of the entity, in screenspace "
     "coordinates.",
     NULL},
    {"faction_id", (getter)PyEntity_get_faction_id,
     (setter)PyEntity_set_faction_id,
     "Index of the faction that the entity belongs to.", NULL},
    {"vision_range", (getter)PyEntity_get_vision_range,
     (setter)PyEntity_set_vision_range,
     "The radius (in OpenGL coordinates) that the entity sees around itself.",
     NULL},
    {"tags", (getter)PyEntity_get_tags, NULL,
     "Return a tuple with all the entity's tags.", NULL},
    {"bounds", (getter)PyEntity_get_bounds, NULL,
     "Return an (X, Y, Z) tuple of the dimensions of the entity's bounding box "
...
static PyTypeObject PyEntity_type = {
    PyVarObject_HEAD_INIT(NULL, 0) "tc.Entity", /* tp_name */
...
static int PyAnimEntity_init(PyAnimEntityObject *self, PyObject *args,
                             PyObject *kwds);
static PyObject *PyAnimEntity_del(PyAnimEntityObject *self);
static PyObject *PyAnimEntity_play_anim(PyAnimEntityObject *self,
                                        PyObject *args, PyObject *kwds);
static PyObject *PyAnimEntity_get_anim(PyAnimEntityObject *self);
static PyObject *PyAnimEntity_pickle(PyAnimEntityObject *self, PyObject *args,
                                     PyObject *kwargs);
static PyObject *PyAnimEntity_unpickle(PyObject *cls, PyObject *args,
                                       PyObject *kwargs);

static PyMethodDef PyAnimEntity_methods[] = {
    {"play_anim", (PyCFunction)PyAnimEntity_play_anim,
     METH_VARARGS | METH_KEYWORDS,
     "Play the animation clip with the specified name. "
     "Set kwarg 'mode=%d' to set the animation mode. The default is "
     "ANIM_MODE_LOOP."},

    {"get_anim", (PyCFunction)PyAnimEntity_get_anim, METH_NOARGS,
     "Get the name of the currently playing animation clip."},

    {"__del__", (PyCFunction)PyAnimEntity_del, METH_NOARGS,
     "Calls the next __del__ in the MRO if there is one, otherwise do "
     "nothing."},

    {"__pickle__", (PyCFunction)PyAnimEntity_pickle, METH_KEYWORDS,
     "Serialize a Permafrost Engine animated entity to a string."},

    {"__unpickle__", (PyCFunction)PyAnimEntity_unpickle,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS,
     "Create a new tc.AnimEntity instance from a string earlier returned from "
     "a __pickle__ method."
     "Returns a tuple of the new instance and the number of bytes consumed "
     "from the stream."},
...
static PyTypeObject PyAnimEntity_type = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "tc.AnimEntity",
    ...
    .tp_doc = "Permafrost Engine animated entity. This type requires the "
              ...
              "This is a subclass of tc.Entity.",
...
static int PyCombatableEntity_init(PyCombatableEntityObject *self,
                                   PyObject *args, PyObject *kwds);
static PyObject *PyCombatableEntity_del(PyCombatableEntityObject *self);
static PyObject *PyCombatableEntity_get_hp(PyCombatableEntityObject *self,
                                           void *closure);
static int PyCombatableEntity_set_hp(PyCombatableEntityObject *self,
                                     PyObject *value, void *closure);
static PyObject *PyCombatableEntity_get_max_hp(PyCombatableEntityObject *self,
                                               void *closure);
static int PyCombatableEntity_set_max_hp(PyCombatableEntityObject *self,
                                         PyObject *value, void *closure);
static PyObject *PyCombatableEntity_get_base_dmg(PyCombatableEntityObject *self,
                                                 void *closure);
static int PyCombatableEntity_set_base_dmg(PyCombatableEntityObject *self,
                                           PyObject *value, void *closure);
static PyObject *
PyCombatableEntity_get_base_armour(PyCombatableEntityObject *self,
                                   void *closure);
static int PyCombatableEntity_set_base_armour(PyCombatableEntityObject *self,
                                              PyObject *value, void *closure);
static PyObject *
PyCombatableEntity_get_attack_range(PyCombatableEntityObject *self,
                                    void *closure);
static int PyCombatableEntity_set_attack_range(PyCombatableEntityObject *self,
                                               PyObject *value, void *closure);
static PyObject *
PyCombatableEntity_hold_position(PyCombatableEntityObject *self);
static PyObject *PyCombatableEntity_attack(PyCombatableEntityObject *self,
                                           PyObject *args);
...
static PyMethodDef PyCombatableEntity_methods[] = {
    {"hold_position", (PyCFunction)PyCombatableEntity_hold_position,
     METH_NOARGS,
     "Issues a 'hold position' order to the entity, stopping it and preventing "
     "it from moving to attack."},

    {"attack", (PyCFunction)PyCombatableEntity_attack, METH_VARARGS,
     "Issues an 'attack move' order to the entity at the XZ position specified "
     "by the argument."},

    {"__del__", (PyCFunction)PyCombatableEntity_del, METH_NOARGS,
     "Calls the next __del__ in the MRO if there is one, otherwise do "
     "nothing."},

    {"__pickle__", (PyCFunction)PyCombatableEntity_pickle, METH_KEYWORDS,
     "Serialize a Permafrost Engine combatable entity to a string."},

    {"__unpickle__", (PyCFunction)PyCombatableEntity_unpickle,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS,
     "Create a new tc.CombatableEntity instance from a string earlier returned "
...
static PyGetSetDef PyCombatableEntity_getset[] = {
    {"hp", (getter)PyCombatableEntity_get_hp, (setter)PyCombatableEntity_set_hp,
     "The current number of hitpoints that the entity has.", NULL},
    {"max_hp", (getter)PyCombatableEntity_get_max_hp,
     (setter)PyCombatableEntity_set_max_hp,
     "The maximum number of hitpoints that the entity starts out with.", NULL},
    {"base_dmg", (getter)PyCombatableEntity_get_base_dmg,
     (setter)PyCombatableEntity_set_base_dmg,
     "The base damage for which this entity's attacks hit.", NULL},
    {"base_armour", (getter)PyCombatableEntity_get_base_armour,
     (setter)PyCombatableEntity_set_base_armour,
     "The base armour (as a fraction from 0.0 to 1.0) specifying which "
     "percentage of incoming "
     "damage is blocked.",
     NULL},
    {"attack_range", (getter)PyCombatableEntity_get_attack_range,
     (setter)PyCombatableEntity_set_attack_range,
     "The distance from which an entity can attack. 0 for melee units.", NULL},
    {NULL} /* Sentinel */
};

static PyTypeObject PyCombatableEntity_type = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "tc.CombatableEntity",
    .tp_basicsize = sizeof(PyCombatableEntityObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = "Permafrost Engine entity which is able to take part in combat. "
              "This type "
              "requires the 'max_hp', 'base_dmg', and 'base_armour' keyword "
              "arguments to be "
              "passed to __init__. An optional 'attack_range' keyword argument "
              "may also be "
              "passed. This is a subclass of tc.Entity.",
...
static int PyBuildableEntity_init(PyBuildableEntityObject *self, PyObject *args,
                                  PyObject *kwds);
...
static PyObject *PyBuildableEntity_get_pos(PyBuildableEntityObject *self,
                                           void *closure);
static int PyBuildableEntity_set_pos(PyBuildableEntityObject *self,
                                     PyObject *value, void *closure);
static PyObject *PyBuildableEntity_get_founded(PyBuildableEntityObject *self,
                                               void *closure);
static PyObject *PyBuildableEntity_get_supplied(PyBuildableEntityObject *self,
                                                void *closure);
static PyObject *PyBuildableEntity_get_completed(PyBuildableEntityObject *self,
                                                 void *closure);
static PyObject *
PyBuildableEntity_get_vision_range(PyBuildableEntityObject *self,
                                   void *closure);
static int PyBuildableEntity_set_vision_range(PyBuildableEntityObject *self,
                                              PyObject *value, void *closure);
static PyObject *
PyBuildableEntity_get_required_resources(PyBuildableEntityObject *self,
                                         void *closure);
static PyObject *PyBuildableEntity_pickle(PyBuildableEntityObject *self,
                                          PyObject *args, PyObject *kwargs);
static PyObject *PyBuildableEntity_unpickle(PyObject *cls, PyObject *args,
                                            PyObject *kwargs);

static PyMethodDef PyBuildableEntity_methods[] = {
    {"mark", (PyCFunction)PyBuildableEntity_mark, METH_NOARGS,
     "Advance a building to the 'MARKED' state from the initial 'PLACEMENT' "
     "state, "
     "where it will wait for a worker to found it."},

    {"found", (PyCFunction)PyBuildableEntity_found,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"supply", (PyCFunction)PyBuildableEntity_supply, METH_NOARGS,
    ...
    {"complete", (PyCFunction)PyBuildableEntity_complete, METH_NOARGS,
     "Advance a building to the 'COMPLETED' state from the 'SUPPLIED' state."},

    {"unobstructed", (PyCFunction)PyBuildableEntity_unobstructed, METH_NOARGS,
     "Returns True if there is no obstruction under any of the building's "
     "tiles."},

    {"__del__", (PyCFunction)PyBuildableEntity_del, METH_NOARGS,
     "Calls the next __del__ in the MRO if there is one, otherwise do "
     "nothing."},

    {"__pickle__", (PyCFunction)PyBuildableEntity_pickle, METH_KEYWORDS,
     "Serialize a Permafrost Engine buildable entity to a string."},

    {"__unpickle__", (PyCFunction)PyBuildableEntity_unpickle,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS,
     "Create a new tc.BuildableEntity instance from a string earlier returned "
     "from a __pickle__ method."
     "Returns a tuple of the new instance and the number of bytes consumed "
     "from the stream."},
...
static PyGetSetDef PyBuildableEntity_getset[] = {
    {"pos", (getter)PyBuildableEntity_get_pos,
     (setter)PyBuildableEntity_set_pos,
     "The XYZ position in worldspace coordinates.", NULL},
    {"vision_range", (getter)PyBuildableEntity_get_vision_range,
     (setter)PyBuildableEntity_set_vision_range,
     "The radius (in OpenGL coordinates) that the entity sees around itself.",
     NULL},
    {"founded", (getter)PyBuildableEntity_get_founded, NULL,
     "Boolean indicating if the building is at or past the 'FOUNDED' state.",
     NULL},
    {"supplied", (getter)PyBuildableEntity_get_supplied, NULL,
     "Boolean indicating if the building is at or past the 'SUPPLIED' state.",
     NULL},
    {"completed", (getter)PyBuildableEntity_get_completed, NULL,
     "Boolean indicating if the building is at or past the 'COMPLETED' state.",
     NULL},
    {"selectable", (getter)PyEntity_get_selectable, NULL,
     "Flag indicating whether this entity can be selected with the mouse.",
     NULL},
    {"required_resources", (getter)PyBuildableEntity_get_required_resources,
     NULL,
...
static PyTypeObject PyBuildableEntity_type = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "tc.BuildableEntity",
    .tp_basicsize = sizeof(PyBuildableEntityObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = "Permafrost Engine entity buildable entity. This is a subclass "
              "of tc.Entity. "
              "The building starts out in the 'PLACEMENT' state. It must then "
              "go through the 'MARKED', "
              "'FOUNDED', 'SUPPLIED', and 'COMPLETED' states. This type "
              "requires the 'required_resources' "
...
static int PyBuilderEntity_init(PyBuilderEntityObject *self, PyObject *args,
                                PyObject *kwds);
static PyObject *PyBuilderEntity_build(PyBuilderEntityObject *self,
                                       PyObject *args);
static PyObject *PyBuilderEntity_pickle(PyBuilderEntityObject *self,
                                        PyObject *args, PyObject *kwargs);
static PyObject *PyBuilderEntity_unpickle(PyObject *cls, PyObject *args,
                                          PyObject *kwargs);

static PyMethodDef PyBuilderEntity_methods[] = {
    {"build", (PyCFunction)PyBuilderEntity_build, METH_VARARGS,
     "Issue an order to build a specific buildable entity."},

    {"__del__", (PyCFunction)PyBuilderEntity_del, METH_NOARGS,
     "Calls the next __del__ in the MRO if there is one, otherwise do "
     "nothing."},

    {"__pickle__", (PyCFunction)PyBuilderEntity_pickle, METH_KEYWORDS,
     "Serialize a Permafrost Engine builder entity to a string."},

    {"__unpickle__", (PyCFunction)PyBuilderEntity_unpickle,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS,
     "Create a new tc.BuilderEntity instance from a string earlier returned "
     "from a __pickle__ method."
     "Returns a tuple of the new instance and the number of bytes consumed "
     "from the stream."},
...
static PyTypeObject PyBuilderEntity_type = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "tc.BuilderEntity",
    .tp_basicsize = sizeof(PyBuilderEntityObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = "Permafrost Engine builder entity. This is a subclass of "
              "tc.Entity. This kind of "
              "entity is able to construct and repair tc.BuildableEntity "
              "instances. This type "
              "requires the 'build_speed' keyword argument to be passed to "
              "'__init__'.",
...
static int PyResourceEntity_init(PyResourceEntityObject *self, PyObject *args,
                                 PyObject *kwds);
static PyObject *PyResourceEntity_pickle(PyResourceEntityObject *self,
                                         PyObject *args, PyObject *kwargs);
static PyObject *PyResourceEntity_unpickle(PyObject *cls, PyObject *args,
                                           PyObject *kwargs);
static PyObject *PyResourceEntity_get_cursor(PyResourceEntityObject *self,
                                             void *closure);
static int PyResourceEntity_set_cursor(PyResourceEntityObject *self,
                                       PyObject *value, void *closure);
static PyObject *PyResourceEntity_get_name(PyResourceEntityObject *self,
                                           void *closure);
static PyObject *PyResourceEntity_get_amount(PyResourceEntityObject *self,
                                             void *closure);
static int PyResourceEntity_set_amount(PyResourceEntityObject *self,
                                       PyObject *value, void *closure);

static PyMethodDef PyResourceEntity_methods[] = {

    {"__del__", (PyCFunction)PyResourceEntity_del, METH_NOARGS,
     "Calls the next __del__ in the MRO if there is one, otherwise do "
     "nothing."},

    {"__pickle__", (PyCFunction)PyResourceEntity_pickle, METH_KEYWORDS,
     "Serialize a Permafrost Engine combatable entity to a string."},

    {"__unpickle__", (PyCFunction)PyResourceEntity_unpickle,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS,
     "Create a new tc.ResourceEntity instance from a string earlier returned "
     "from a __pickle__ method."
     "Returns a tuple of the new instance and the number of bytes consumed "
     "from the stream."},
...
static PyGetSetDef PyResourceEntity_getset[] = {
    {"cursor", (getter)PyResourceEntity_get_cursor,
     (setter)PyResourceEntity_set_cursor,
     "The name of the cursor to display as a contextual gather command "
     "indicator when hovering over the resource.",
     NULL},
    {"resource_name", (getter)PyResourceEntity_get_name, NULL,
     "The name of resource that can be harvested from this entity", NULL},
    {"resource_amount", (getter)PyResourceEntity_get_amount,
     (setter)PyResourceEntity_set_amount,
     "The amount of resources that this entity currently holds", NULL},
    {NULL} /* Sentinel */
};

static PyTypeObject PyResourceEntity_type = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "tc.ResourceEntity",
    .tp_basicsize = sizeof(PyResourceEntityObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = "Permafrost Engine resource entity. This is a subclass of "
              "tc.Entity. This type "
              "requires the 'resource_name' and 'resource_amount' keyword "
              "arguments to be passed to '__init__'.",
...
static PyObject *PyHarvesterEntity_gather(PyHarvesterEntityObject *self,
                                          PyObject *args);
static PyObject *PyHarvesterEntity_drop_off(PyHarvesterEntityObject *self,
                                            PyObject *args);
static PyObject *PyHarvesterEntity_transport(PyHarvesterEntityObject *self,
                                             PyObject *args);
static PyObject *PyHarvesterEntity_get_curr_carry(PyHarvesterEntityObject *self,
                                                  PyObject *args);
static PyObject *
PyHarvesterEntity_clear_curr_carry(PyHarvesterEntityObject *self);
static PyObject *PyHarvesterEntity_get_max_carry(PyHarvesterEntityObject *self,
                                                 PyObject *args);
static PyObject *PyHarvesterEntity_set_max_carry(PyHarvesterEntityObject *self,
                                                 PyObject *args);
static PyObject *
PyHarvesterEntity_get_gather_speed(PyHarvesterEntityObject *self,
                                   PyObject *args);
static PyObject *
PyHarvesterEntity_set_gather_speed(PyHarvesterEntityObject *self,
                                   PyObject *args);
static PyObject *
PyHarvesterEntity_increase_transport_priority(PyHarvesterEntityObject *self,
                                              PyObject *args);
static PyObject *
PyHarvesterEntity_decrease_transport_priority(PyHarvesterEntityObject *self,
                                              PyObject *args);
static PyObject *PyHarvesterEntity_pickle(PyHarvesterEntityObject *self,
                                          PyObject *args, PyObject *kwargs);
static PyObject *PyHarvesterEntity_unpickle(PyObject *cls, PyObject *args,
                                            PyObject *kwargs);
static PyObject *PyHarvesterEntity_get_strategy(PyHarvesterEntityObject *self,
                                                void *closure);
static int PyHarvesterEntity_set_strategy(PyHarvesterEntityObject *self,
                                          PyObject *value, void *closure);
static PyObject *
PyHarvesterEntity_get_total_carry(PyHarvesterEntityObject *self, void *closure);
static PyObject *
PyHarvesterEntity_get_transport_priority(PyHarvesterEntityObject *self,
                                         void *closure);

static PyMethodDef PyHarvesterEntity_methods[] = {

    {"__del__", (PyCFunction)PyHarvesterEntity_del, METH_NOARGS,
     "Calls the next __del__ in the MRO if there is one, otherwise do "
     "nothing."},

    {"gather", (PyCFunction)PyHarvesterEntity_gather, METH_VARARGS,
     "Instruct an entity to harvest a particular resource."},

    {"drop_off", (PyCFunction)PyHarvesterEntity_drop_off, METH_VARARGS,
     "Instruct an entity to bring the resources it is currently holding to the "
     "specified storage site."},

    {"transport", (PyCFunction)PyHarvesterEntity_transport, METH_VARARGS,
     "Instruct an entity to bring resources to the target storage site, using "
     "its' strategy and priority list "
     "to select the appropriate source storage sites."},

    {"get_curr_carry", (PyCFunction)PyHarvesterEntity_get_curr_carry,
     METH_VARARGS,
     "Get the amount of a particular resources that this entity is currently "
     "carrying."},

    {"clear_curr_carry", (PyCFunction)PyHarvesterEntity_clear_curr_carry,
     METH_NOARGS, "Clear any resources that the unit is currently carrying."},

    {"get_max_carry", (PyCFunction)PyHarvesterEntity_get_max_carry,
     METH_VARARGS,
     "Get the maximum amount of a particular resources that this entity is "
     "able to carry."},

    {"set_max_carry", (PyCFunction)PyHarvesterEntity_set_max_carry,
     METH_VARARGS,
     "Set how much of the specified resource the entity is able to carry at a "
     "time."},

    {"get_gather_speed", (PyCFunction)PyHarvesterEntity_get_gather_speed,
     METH_VARARGS,
     "Get how much of the specified resource the entity gathers in a single "
     "animation."},

    {"set_gather_speed", (PyCFunction)PyHarvesterEntity_set_gather_speed,
     METH_VARARGS,
    ...
    {"increase_transport_priority",
     ...
     "Move the specified resource up in the priority list the peasant uses for "
    ...
    {"__pickle__", (PyCFunction)PyHarvesterEntity_pickle, METH_KEYWORDS,
     "Serialize a Permafrost Engine combatable entity to a string."},

    {"__unpickle__", (PyCFunction)PyHarvesterEntity_unpickle,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS,
     "Create a new tc.HarvesterEntity instance from a string earlier returned "
     "from a __pickle__ method."
     "Returns a tuple of the new instance and the number of bytes consumed "
     "from the stream."},
...
static PyGetSetDef PyHarvesterEntity_getset[] = {
    {"total_carry", (getter)PyHarvesterEntity_get_total_carry, NULL,
     "Get the total amount of resources currently carried by the entity.",
     NULL},
    {"transport_priority", (getter)PyHarvesterEntity_get_transport_priority,
     NULL,
     "Get the ordered list of the resource names that the harvester will "
     "prioritize transporting.",
     NULL},
    {"strategy", (getter)PyHarvesterEntity_get_strategy,
     (setter)PyHarvesterEntity_set_strategy,
     "The approach used by the harvester to pick the next storage site to get "
     "resources from. "
     "Must be a tc.TRANSPORT_ enum value.",
     NULL},
    {NULL} /* Sentinel */
};

static PyTypeObject PyHarvesterEntity_type = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "tc.HarvesterEntity",
    .tp_basicsize = sizeof(PyHarvesterEntityObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = "Permafrost Engine resource entity. This is a subclass of "
              "tc.Entity. This kind of "
              "entity is able to gather and transport resources (from "
              "tc.ResourceEntity types).",
...
static PyObject *
PyStorageSiteEntity_get_curr_amount(PyStorageSiteEntityObject *self,
                                    PyObject *args);
static PyObject *
PyStorageSiteEntity_set_curr_amount(PyStorageSiteEntityObject *self,
                                    PyObject *args);
static PyObject *
PyStorageSiteEntity_get_capacity(PyStorageSiteEntityObject *self,
                                 PyObject *args);
static PyObject *
PyStorageSiteEntity_set_capacity(PyStorageSiteEntityObject *self,
                                 PyObject *args);
static PyObject *
PyStorageSiteEntity_get_storable(PyStorageSiteEntityObject *self,
                                 void *closure);
static PyObject *
PyStorageSiteEntity_get_desired(PyStorageSiteEntityObject *self,
                                PyObject *args);
static PyObject *
PyStorageSiteEntity_set_desired(PyStorageSiteEntityObject *self,
                                PyObject *args);
static PyObject *
PyStorageSiteEntity_get_do_not_take(PyStorageSiteEntityObject *self,
                                    void *closure);
static int PyStorageSiteEntity_set_do_not_take(PyStorageSiteEntityObject *self,
                                               PyObject *value, void *closure);
static PyObject *PyStorageSiteEntity_pickle(PyStorageSiteEntityObject *self,
                                            PyObject *args, PyObject *kwargs);
static PyObject *PyStorageSiteEntity_unpickle(PyObject *cls, PyObject *args,
                                              PyObject *kwargs);

static PyMethodDef PyStorageSiteEntity_methods[] = {

    {"__del__", (PyCFunction)PyStorageSiteEntity_del, METH_NOARGS,
     "Calls the next __del__ in the MRO if there is one, otherwise do "
     "nothing."},

    {"get_curr_amount", (PyCFunction)PyStorageSiteEntity_get_curr_amount,
     METH_VARARGS,
     "Gets the amount of the specified resource currently stored in the "
     "storage site."},

    {"set_curr_amount", (PyCFunction)PyStorageSiteEntity_set_curr_amount,
     METH_VARARGS,
     "Sets the amount of the specified resource currently stored in the "
     "storage site."},

    {"get_capacity", (PyCFunction)PyStorageSiteEntity_get_capacity,
     METH_VARARGS,
     "Gets the maximum amount of the specified resource that can be stored in "
     "the storage site."},

    {"set_capacity", (PyCFunction)PyStorageSiteEntity_set_capacity,
     METH_VARARGS,
     "Sets the maximum amount of the specified resource that can be stored in "
     "the storage site."},

    {"get_desired", (PyCFunction)PyStorageSiteEntity_get_desired, METH_VARARGS,
     "Gets the target amount of the specified resource that harvesters will "
     "aim to store there."},

    {"set_desired", (PyCFunction)PyStorageSiteEntity_set_desired, METH_VARARGS,
     "Sets the target amount of the specified resource that harvesters will "
     "aim to store there."},

    {"__pickle__", (PyCFunction)PyStorageSiteEntity_pickle, METH_KEYWORDS,
     "Serialize a Permafrost Engine combatable entity to a string."},

    {"__unpickle__", (PyCFunction)PyStorageSiteEntity_unpickle,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS,
     "Create a new tc.StorageSiteEntity instance from a string earlier "
...
static PyGetSetDef PyStorageSiteEntity_getset[] = {
    {"storable", (getter)PyStorageSiteEntity_get_storable, NULL,
     "The list of resources that are currently able to be held at this storage "
     "site.",
     NULL},
    {"do_not_take", (getter)PyStorageSiteEntity_get_do_not_take,
     (setter)PyStorageSiteEntity_set_do_not_take,
     "The list of resources that are currently able to be held at this storage "
     "site.",
     NULL},
    {NULL} /* Sentinel */
...
static PyTypeObject PyStorageSiteEntity_type = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "tc.StorageSiteEntity",
    .tp_basicsize = sizeof(PyStorageSiteEntityObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc = "Permafrost Engine storage site entity. This is a subclass of "
              "tc.Entity. This kind of "
              "entity is able to hold resources that can be dropped off by "
              "tc.HarvesterEntity types.",
...
static PyObject *PyMovableEntity_move(PyMovableEntityObject *self,
                                      PyObject *args);
static PyObject *PyMovableEntity_del(PyMovableEntityObject *self);
static PyObject *PyMovableEntity_pickle(PyMovableEntityObject *self,
                                        PyObject *args, PyObject *kwargs);
static PyObject *PyMovableEntity_unpickle(PyObject *cls, PyObject *args,
                                          PyObject *kwargs);

static PyObject *PyMovableEntity_get_speed(PyMovableEntityObject *self,
                                           void *closure);
static int PyMovableEntity_set_speed(PyMovableEntityObject *self,
                                     PyObject *value, void *closure);

static PyGetSetDef PyMovableEntity_getset[] = {
    {"speed", (getter)PyMovableEntity_get_speed,
     (setter)PyMovableEntity_set_speed,
     "Entity's movement speed (in OpenGL coordinates per second).", NULL},
    {NULL} /* Sentinel */
};

static PyMethodDef PyMovableEntity_methods[] = {

    {"move", (PyCFunction)PyMovableEntity_move, METH_VARARGS,
     "Issues a 'move' order to the entity at the XZ position specified by the "
     "argument."},

    {"__del__", (PyCFunction)PyMovableEntity_del, METH_NOARGS,
     "Calls the next __del__ in the MRO if there is one, otherwise do "
     "nothing."},

    {"__pickle__", (PyCFunction)PyMovableEntity_pickle, METH_KEYWORDS,
     "Serialize a Permafrost Engine combatable entity to a string."},

    {"__unpickle__", (PyCFunction)PyMovableEntity_unpickle,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS,
     "Create a new tc.MovableEntity instance from a string earlier returned "
     "from a __pickle__ method."
     "Returns a tuple of the new instance and the number of bytes consumed "
     "from the stream."},
...
static PyTypeObject PyMovableEntity_type = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "tc.MovableEntity",
    .tp_basicsize = sizeof(PyMovableEntityObject),
    .tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,
    .tp_doc =
        "Permafrost Engine movable entity. This is a subclass of tc.Entity. "
        "This kind of "
...
static bool s_has_super_method(const char *method_name, PyObject *type,
                               PyObject *self) {
  bool ret = false;

  PyObject *super_obj =
      PyObject_CallFunction((PyObject *)&PySuper_Type, "(OO)", type, self);
  if (!super_obj) {
...
static PyObject *s_super_del(PyObject *self, PyTypeObject *type) {
  ...
  PyObject *ret =
      s_call_super_method("__del__", (PyObject *)type, self, args, NULL);
  Py_DECREF(args);
  return ret;
}
...
static PyObject *PyEntity_new(PyTypeObject *type, PyObject *args,
  ...
  struct entity *ent = AL_EntityFromTCObj(dirpath, filename, name, uid);
  if (!ent) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Unable to load specified tc.Entity TCOBJ model.");
    return NULL;
  }

  self = (PyEntityObject *)type->tp_alloc(type, 0);
  if (!self) {
    PyErr_SetString(PyExc_RuntimeError, "Unable to allocate new tc.Entity.");
    AL_EntityFree(ent);
    return NULL;
  } else {
    self->ent = ent;
  ...
  if (kwds) {
    ...
    if (posobj) {
      if (!PyTuple_Check(posobj) ||
          !PyArg_ParseTuple(posobj, "fff", &pos.x, &pos.y, &pos.z)) {
        PyErr_SetString(PyExc_TypeError,
                        "'pos' keyword argument must be a tuple of 3 floats.");
        return NULL;
      }
    }
  }
...
static int PyEntity_set_name(PyEntityObject *self, PyObject *value,
  ...
  const char *s = tc_strdup(PyString_AsString(value));
  if (!s) {
    PyErr_NoMemory();
    return -1;
  }

  TC_FREE(self->ent->name);
  self->ent->name = s;
  return 0;
}
...
static int PyEntity_set_pos(PyEntityObject *self, PyObject *value,
  ...
  vec3_t newpos;
  if (!PyArg_ParseTuple(value, "fff", &newpos.raw[0], &newpos.raw[1],
                        &newpos.raw[2])) {
    return -1;
  }
...
static int PyEntity_set_faction_id(PyEntityObject *self, PyObject *value,
  ...
  if (!PyInt_Check(value)) {
    PyErr_SetString(PyExc_TypeError,
                    "faction_id attribute must be an integer.");
    return -1;
  }
...
static PyObject *PyEntity_get_vision_range(PyEntityObject *self,
                                           void *closure) {
  if (self->ent->flags & ENTITY_FLAG_ZOMBIE) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Cannot get attribute of zombie entity.");
    return NULL;
  }
...
static int PyEntity_set_vision_range(PyEntityObject *self, PyObject *value,
  ...
  if (!PyFloat_Check(value)) {
    PyErr_SetString(PyExc_TypeError,
                    "vision_range attribute must be an float.");
    return -1;
  }
...
static PyObject *PyEntity_get_bounds(PyEntityObject *self, void *closure) {
  struct obb obb;
  Entity_CurrentOBB(self->ent, &obb, true);
  return Py_BuildValue("(fff)", obb.half_lengths[0] * 2,
                       obb.half_lengths[1] * 2, obb.half_lengths[2] * 2);
}
...
static PyObject *PyEntity_register(PyEntityObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "iOO", &event, &callable, &user_arg)) {
    PyErr_SetString(PyExc_TypeError,
                    "Arguments must be an integer and two objects.");
    return NULL;
  }
...
static PyObject *PyEntity_unregister(PyEntityObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "iO", &event, &callable)) {
    PyErr_SetString(PyExc_TypeError,
                    "Arguments must an integer and one object.");
    return NULL;
  }
...
static PyObject *PyEntity_notify(PyEntityObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "iO", &event, &arg)) {
    PyErr_SetString(PyExc_TypeError,
                    "Arguments must be an integer and one object.");
    return NULL;
  }
...
static PyObject *PyEntity_face_towards(PyEntityObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "(fff)", &pos.raw[0], &pos.raw[1], &pos.raw[2])) {
    PyErr_SetString(PyExc_TypeError,
                    "Argument must be a tuple of 3 floats (position to face).");
    return NULL;
  }
...
static PyObject *PyEntity_set_model(PyEntityObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "ss", &dirpath, &filename)) {
    PyErr_SetString(
        PyExc_TypeError,
        "Expecting two string arguments: directory path and TCOBJ file name.");
    return NULL;
  }
  ...
  if (!AL_EntitySetTCObj(self->ent, dirpath, filename)) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Could not set the model to the specified TCOBJ file.");
    return NULL;
  }
  Py_RETURN_NONE;
}
...
static PyObject *PyEntity_pickle(PyEntityObject *self, PyObject *args,
  ...
  PyObject *sel_radius =
      Py_BuildValue("f", G_GetSelectionRadius(self->ent->uid));
...
static PyObject *PyEntity_unpickle(PyObject *cls, PyObject *args,
  ...
  if (!basedir || !filename || !name || !uid) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Could not unpickle internal state of tc.Entity instance");
    goto fail_unpickle;
  }
  ...
  if (!pos || !scale || !rotation || !flags || !sel_radius || !faction_id ||
      !vision_range || !tags) {

    PyErr_SetString(PyExc_RuntimeError,
                    "Could not unpickle attributes of tc.Entity instance");
    goto fail_unpickle_atts;
  }

  PyObject *ent_args = Py_BuildValue("(OOO)", basedir, filename, name);
  PyObject *ent_kwargs =
      Py_BuildValue("{s:O, s:O}", "__uid__", uid, "__extra_flags__", flags);

  /* Use the 'plain' (i.e. direct successor with no extra overrides) as the
   * arugment to avoid calling any magic that might be risiding in the
   * user-implemented __new__
   */
  PyTypeObject *heap_subtype =
      (PyTypeObject *)S_Pickle_PlainHeapSubtype((PyTypeObject *)cls);
  assert(heap_subtype->tp_new);

  PyObject *entobj =
      heap_subtype->tp_new((struct _typeobject *)cls, ent_args, ent_kwargs);
  ...
  vec3_t rawpos;
  CHK_TRUE(PyArg_ParseTuple(pos, "fff", &rawpos.x, &rawpos.y, &rawpos.z),
           fail_unpickle_atts);
  G_Pos_Set(ent, rawpos);

  vec3_t vscale;
  CHK_TRUE(PyArg_ParseTuple(scale, "fff", &vscale.x, &vscale.y, &vscale.z),
           fail_unpickle_atts);
  Entity_SetScale(ent->uid, vscale);

  quat_t qrot;
  CHK_TRUE(
      PyArg_ParseTuple(rotation, "ffff", &qrot.x, &qrot.y, &qrot.z, &qrot.w),
      fail_unpickle_atts);
...
static PyObject *PyCombatableEntity_attack(PyCombatableEntityObject *self,
  ...
  if (!G_PointInsideMap(xz_pos)) {
    PyErr_SetString(PyExc_RuntimeError,
                    "The movement point must be within the map bounds.");
    return NULL;
  }
...
static PyObject *PyCombatableEntity_pickle(PyCombatableEntityObject *self,
                                           PyObject *args, PyObject *kwargs) {
  PyObject *ret =
      s_call_super_method("__pickle__", (PyObject *)&PyCombatableEntity_type,
  ...
  CHK_TRUE(
      SDL_RWwrite(stream, PyString_AS_STRING(ret), PyString_GET_SIZE(ret), 1),
      fail_stream);
...
static PyObject *PyCombatableEntity_unpickle(PyObject *cls, PyObject *args,
  ...
  PyObject *max_hp = NULL, *base_dmg = NULL, *base_armour = NULL,
           *curr_hp = NULL, *attack_range = NULL;
  PyObject *ret = NULL;
  int status;

  PyObject *tuple = s_call_super_method(
      "__unpickle__", (PyObject *)&PyCombatableEntity_type, cls, args, kwargs);
  if (!tuple)
    return NULL;
  ...
  CHK_TRUE(
      SDL_RWwrite(stream, PyString_AS_STRING(str), PyString_GET_SIZE(str), 1),
      fail_unpickle);
  SDL_RWseek(stream, nread, RW_SEEK_SET);

  if (!(((PyCombatableEntityObject *)ent)->super.ent->flags &
        ENTITY_FLAG_ZOMBIE)) {
...
static int PyAnimEntity_init(PyAnimEntityObject *self, PyObject *args,
  ...
  if (!kwds ||
      ((idle_clip = PyDict_GetItemString(kwds, "idle_clip")) == NULL)) {
    PyErr_SetString(PyExc_TypeError, "'idle_clip' keyword argument required "
                                     "for initializing tc.AnimEntity types.");
    return -1;
  }

  if (!PyString_Check(idle_clip)) {
    PyErr_SetString(PyExc_TypeError,
                    "'idle_clip' keyword argument must be a string.");
    return -1;
  }

  if (!A_HasClip(self->super.ent->uid, PyString_AS_STRING(idle_clip))) {
    char errbuff[256];
    tc_snprintf(errbuff, sizeof(errbuff),
                "%s instance has no animation clip named '%s'.",
  ...
  /* Call the next __init__ method in the MRO. This is required for all __init__
   * calls in the MRO to complete in cases when this class is one of multiple
   * base classes of another type. This allows this type to be used as one of
   * many mix-in bases. */
  PyObject *ret = s_call_super_method(
      "__init__", (PyObject *)&PyAnimEntity_type, (PyObject *)self, args, kwds);
  if (!ret)
...
static PyObject *PyAnimEntity_play_anim(PyAnimEntityObject *self,
  ...
  if (kwds && (mode_obj = PyDict_GetItemString(kwds, "mode"))) {
    ...
    if (!PyInt_Check(mode_obj) ||
      ...
      PyErr_SetString(PyExc_TypeError,
                      "Mode kwarg must be a valid animation mode (int).");
      return NULL;
    }
  }
...
static PyObject *PyAnimEntity_pickle(PyAnimEntityObject *self, PyObject *args,
                                     PyObject *kwargs) {
  PyObject *ret =
      s_call_super_method("__pickle__", (PyObject *)&PyAnimEntity_type,
                          (PyObject *)self, args, kwargs);
  ...
  PyObject *idle_clip =
      PyString_FromString(A_GetIdleClip(self->super.ent->uid));
...
static PyObject *PyAnimEntity_unpickle(PyObject *cls, PyObject *args,
  ...
  PyObject *tuple = s_call_super_method(
      "__unpickle__", (PyObject *)&PyAnimEntity_type, cls, args, kwargs);
  if (!tuple)
    return NULL;
  ...
  nread = SDL_RWseek(stream, 0, RW_SEEK_CUR);
  A_SetIdleClip(((PyAnimEntityObject *)ent)->super.ent->uid,
                PyString_AS_STRING(idle_clip), 24);
...
static int PyCombatableEntity_init(PyCombatableEntityObject *self,
  ...
  if (!kwds || ((max_hp = PyDict_GetItemString(kwds, "max_hp")) == NULL) ||
      ((base_dmg = PyDict_GetItemString(kwds, "base_dmg")) == NULL) ||
      ((base_armour = PyDict_GetItemString(kwds, "base_armour")) == NULL)) {
    PyErr_SetString(PyExc_TypeError,
                    "'max_hp', 'base_dmg', and 'base_armour' keyword arguments "
                    "required for initializing tc.CombatableEntity types.");
    return -1;
  }

  PyObject *attack_range = PyDict_GetItemString(kwds, "attack_range");
  if (attack_range &&
      (PyCombatableEntity_set_attack_range(self, attack_range, NULL) != 0))
    return -1; /* Exception already set */

  PyObject *proj_desc = PyDict_GetItemString(kwds, "projectile_descriptor");
  if (proj_desc) {

    const char *dir, *tcobj;
    vec3_t scale;
    float speed;

    if (!PyTuple_Check(proj_desc) ||
        !PyArg_ParseTuple(proj_desc, "ss(fff)f", &dir, &tcobj, &scale.x,
                          &scale.y, &scale.z, &speed)) {
      PyErr_SetString(PyExc_TypeError,
                      "Optional 'projectile_descriptor' keyword argument must "
                      "be a tuple of 4 items: "
                      "tcobj directory (string), tcobj name (string), scale "
   ...
   * many mix-in bases. */
  PyObject *ret =
      s_call_super_method("__init__", (PyObject *)&PyCombatableEntity_type,
...
static int PyCombatableEntity_set_hp(PyCombatableEntityObject *self,
  ...
  if (self->super.ent->flags & ENTITY_FLAG_ZOMBIE) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Cannot set attribute of zombie entity.");
    return -1;
  }
...
static int PyCombatableEntity_set_max_hp(PyCombatableEntityObject *self,
  ...
  if (max_hp < 0) {
    PyErr_SetString(PyExc_RuntimeError,
                    "max_hp must be greater or equal to 0 (0 = invulnerable).");
    return -1;
  }
...
static int PyCombatableEntity_set_base_dmg(PyCombatableEntityObject *self,
  ...
  if (base_dmg < 0) {
    PyErr_SetString(PyExc_RuntimeError,
                    "base_dmg must be greater than or equal to 0.");
    return -1;
  }
...
static int PyCombatableEntity_set_base_armour(PyCombatableEntityObject *self,
  ...
  if (base_armour < 0.0f || base_armour > 1.0f) {
    PyErr_SetString(PyExc_RuntimeError,
                    "base_armour must be in the range of [0.0, 1.0].");
    return -1;
  }
...
static int PyCombatableEntity_set_attack_range(PyCombatableEntityObject *self,
  ...
  if (range < 0.0f) {
    PyErr_SetString(PyExc_TypeError,
                    "attack_range attribute must be a positive value.");
    return -1;
  }
...
static int PyBuildableEntity_init(PyBuildableEntityObject *self, PyObject *args,
  ...
  if (!kwds || ((required_resources = PyDict_GetItemString(
                     kwds, "required_resources")) == NULL)) {
    PyErr_SetString(PyExc_TypeError,
                    "'required_resources' keyword argument required for "
                    "initializing tc.BuildableEntity types.");
    return -1;
  }
   ...
   * many mix-in bases. */
  PyObject *ret =
      s_call_super_method("__init__", (PyObject *)&PyBuildableEntity_type,
                          (PyObject *)self, args, kwds);
  if (!ret)
    return -1; /* Exception already set */
  Py_DECREF(ret);
...
static PyObject *PyBuildableEntity_mark(PyBuildableEntityObject *self) {
  ...
  if (!G_Building_Mark(self->super.ent)) {
    PyErr_SetString(
        PyExc_RuntimeError,
        "Unable to mark building. It must be in the PLACEMENT state.");
    return NULL;
  }
  Py_RETURN_NONE;
}
...
static PyObject *PyBuildableEntity_found(PyBuildableEntityObject *self,
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "|ii", kwlist, &blocking,
                                   &force)) {
    PyErr_SetString(PyExc_TypeError,
                    "Two (optional) arguments: blocking (int) and force (int)");
    return NULL;
  }
  ...
  if (!force && !G_Building_Unobstructed(self->super.ent)) {
    PyErr_SetString(
        PyExc_RuntimeError,
        "The tiles under the building must not be obstructed by any objects.");
    return NULL;
  }
  ...
  if (!G_Building_Found(self->super.ent, blocking)) {
    PyErr_SetString(
        PyExc_RuntimeError,
        "Unable to found building. It must be in the MARKED state.");
    return NULL;
  }
  Py_RETURN_NONE;
}
...
static PyObject *PyBuildableEntity_supply(PyBuildableEntityObject *self) {
  ...
  if (!G_Building_Supply(self->super.ent)) {
    PyErr_SetString(
        PyExc_RuntimeError,
        "Unable to supply building. It must be in the FOUNDED state.");
    return NULL;
  }
  Py_RETURN_NONE;
}
...
static PyObject *PyBuildableEntity_complete(PyBuildableEntityObject *self) {
  ...
  if (!G_Building_Complete(self->super.ent)) {
    PyErr_SetString(
        PyExc_RuntimeError,
        "Unable to complete building. It must be in the SUPPLIED state.");
    return NULL;
  }
  Py_RETURN_NONE;
}
...
static PyObject *PyBuildableEntity_get_founded(PyBuildableEntityObject *self,
  ...
  if (self->super.ent->flags & ENTITY_FLAG_ZOMBIE) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Cannot access attribute of zombie entity.");
    return NULL;
  }
...
PyBuildableEntity_get_required_resources(PyBuildableEntityObject *self,
  ...
  size_t nreq =
      G_Building_GetAllRequired(self->super.ent->uid, max, names, amounts);
...
static PyObject *PyBuildableEntity_unpickle(PyObject *cls, PyObject *args,
                                            PyObject *kwargs) {
  return s_call_super_method(
      "__unpickle__", (PyObject *)&PyBuildableEntity_type, cls, args, kwargs);
}
...
static int PyBuilderEntity_init(PyBuilderEntityObject *self, PyObject *args,
  ...
  if (!kwds ||
      ((build_speed = PyDict_GetItemString(kwds, "build_speed")) == NULL)) {
    PyErr_SetString(PyExc_TypeError,
                    "'build_speed' keyword argument required for initializing "
                    "tc.BuilderEntity types.");
    return -1;
  }

  if (!PyInt_Check(build_speed)) {
    PyErr_SetString(PyExc_TypeError,
                    "'build_speed' keyword argument must be an integer.");
    return -1;
  }
   ...
   * many mix-in bases. */
  PyObject *ret =
      s_call_super_method("__init__", (PyObject *)&PyBuilderEntity_type,
                          (PyObject *)self, args, kwds);
  if (!ret)
    return -1; /* Exception already set */
  Py_DECREF(ret);
...
static PyObject *PyBuilderEntity_build(PyBuilderEntityObject *self,
  ...
  if (!PyArg_ParseTuple(args, "O", &building) ||
    ...
    PyErr_SetString(PyExc_TypeError,
                    "Expecting 1 argument: a tc.BuildableEntity instance");
    return NULL;
  }

  G_Builder_Build(self->super.ent,
                  ((PyBuildableEntityObject *)building)->super.ent);
  Py_RETURN_NONE;
}
...
static PyObject *PyBuilderEntity_pickle(PyBuilderEntityObject *self,
                                        PyObject *args, PyObject *kwargs) {
  PyObject *ret =
      s_call_super_method("__pickle__", (PyObject *)&PyBuilderEntity_type,
                          (PyObject *)self, args, kwargs);
  ...
  if (!(self->super.ent->flags & ENTITY_FLAG_ZOMBIE)) {
    ...
    PyObject *build_speed =
        PyInt_FromLong(G_Builder_GetBuildSpeed(self->super.ent));
...
fail_stream:
  Py_XDECREF(ret);
  PyErr_SetString(PyExc_RuntimeError,
                  "Unable to pickle tc.BuilderEntity state");
  return NULL;
}
...
static PyObject *PyBuilderEntity_unpickle(PyObject *cls, PyObject *args,
  ...
  PyObject *tuple = s_call_super_method(
      "__unpickle__", (PyObject *)&PyBuilderEntity_type, cls, args, kwargs);
  if (!tuple)
    return NULL;
  ...
  if (!(((PyBuilderEntityObject *)ent)->super.ent->flags &
        ENTITY_FLAG_ZOMBIE)) {
    ...
    nread = SDL_RWseek(stream, 0, RW_SEEK_CUR);
    G_Builder_SetBuildSpeed(((PyBuilderEntityObject *)ent)->super.ent,
                            PyInt_AS_LONG(build_speed));
  }
...
fail_stream:
  ...
  if (!ret && !PyErr_Occurred()) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Unable to unpickle tc.BuilderEntity state");
  }
  return ret;
}
...
static int PyResourceEntity_init(PyResourceEntityObject *self, PyObject *args,
  ...
  if (!kwds || ((name = PyDict_GetItemString(kwds, "resource_name")) == NULL) ||
      ((amount = PyDict_GetItemString(kwds, "resource_amount")) == NULL)) {
    PyErr_SetString(PyExc_TypeError,
                    "'resource_name' and 'resource_amount' keyword arguments "
                    "required for initializing tc.ResourceEntity types.");
    return -1;
  }

  if (!PyString_Check(name)) {
    PyErr_SetString(PyExc_TypeError,
                    "'resource_name' keyword argument must be a string.");
    return -1;
  }

  if (!PyInt_Check(amount)) {
    PyErr_SetString(PyExc_TypeError,
                    "'resource_amount' keyword argument must be a string.");
    return -1;
  }
   ...
   * many mix-in bases. */
  PyObject *ret =
      s_call_super_method("__init__", (PyObject *)&PyResourceEntity_type,
                          (PyObject *)self, args, kwds);
  if (!ret)
    return -1; /* Exception already set */
  Py_DECREF(ret);
...
static PyObject *PyResourceEntity_pickle(PyResourceEntityObject *self,
                                         PyObject *args, PyObject *kwargs) {
  PyObject *ret =
      s_call_super_method("__pickle__", (PyObject *)&PyResourceEntity_type,
                          (PyObject *)self, args, kwargs);
  ...
  if (!(self->super.ent->flags & ENTITY_FLAG_ZOMBIE)) {
    ...
    PyObject *name =
        PyString_FromString(G_Resource_GetName(self->super.ent->uid));
    CHK_TRUE(name, fail_pickle);
    ...
    PyObject *amount =
        PyInt_FromLong(G_Resource_GetAmount(self->super.ent->uid));
...
static PyObject *PyResourceEntity_unpickle(PyObject *cls, PyObject *args,
  ...
  PyObject *tuple = s_call_super_method(
      "__unpickle__", (PyObject *)&PyResourceEntity_type, cls, args, kwargs);
  if (!tuple)
    return NULL;
  ...
  if (!(((PyResourceEntityObject *)ent)->super.ent->flags &
        ENTITY_FLAG_ZOMBIE)) {
    ...
    G_Resource_SetName(((PyResourceEntityObject *)ent)->super.ent->uid,
    ...
    G_Resource_SetAmount(((PyResourceEntityObject *)ent)->super.ent->uid,
...
static PyObject *PyHarvesterEntity_gather(PyHarvesterEntityObject *self,
  ...
  if (!PyArg_ParseTuple(args, "O", &resource) ||
      !PyObject_IsInstance((PyObject *)resource,
                           (PyObject *)&PyResourceEntity_type)) {
    PyErr_SetString(PyExc_TypeError,
                    "Argument must be a tc.ResourceEntity instance.");
    return NULL;
  }
  ...
  if (!G_Harvester_Gather(self->super.ent, resource->super.ent)) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Unable to gather the specified resource.");
    return NULL;
  }
  Py_RETURN_NONE;
}
...
static PyObject *PyHarvesterEntity_drop_off(PyHarvesterEntityObject *self,
  ...
  if (!PyArg_ParseTuple(args, "O", &storage) ||
      !PyObject_IsInstance((PyObject *)storage,
                           (PyObject *)&PyStorageSiteEntity_type)) {
    PyErr_SetString(PyExc_TypeError,
                    "Argument must be a tc.StorageSiteEntity instance.");
    return NULL;
  }
  ...
  if (!G_Harvester_DropOff(self->super.ent, storage->super.ent)) {
    PyErr_SetString(
        PyExc_RuntimeError,
        "Unable to drop off resource at the specified storage site.");
    return NULL;
  }
  Py_RETURN_NONE;
}
...
static PyObject *PyHarvesterEntity_transport(PyHarvesterEntityObject *self,
  ...
  if (!G_Harvester_Transport(self->super.ent, storage->super.ent)) {
    PyErr_SetString(
        PyExc_RuntimeError,
        "Unable to transport resources to the specified storage site.");
    return NULL;
  }
  Py_RETURN_NONE;
}
...
static PyObject *PyHarvesterEntity_get_curr_carry(PyHarvesterEntityObject *self,
  ...
  if (!PyArg_ParseTuple(args, "s", &rname)) {
    PyErr_SetString(PyExc_TypeError,
                    "Expecting one arguments: resource name (string).");
    return NULL;
  }
...
PyHarvesterEntity_clear_curr_carry(PyHarvesterEntityObject *self) {
  if (self->super.ent->flags & ENTITY_FLAG_ZOMBIE) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Cannot invoke method of zombie entity.");
    return NULL;
  }
...
static PyObject *PyHarvesterEntity_set_max_carry(PyHarvesterEntityObject *self,
  ...
  if (!PyArg_ParseTuple(args, "si", &name, &amount)) {
    PyErr_SetString(
        PyExc_TypeError,
        "Expecting two arguments: name (string) and amount (integer).");
    return NULL;
  }
...
PyHarvesterEntity_set_gather_speed(PyHarvesterEntityObject *self,
  ...
  if (!PyArg_ParseTuple(args, "sf", &name, &amount)) {
    PyErr_SetString(
        PyExc_TypeError,
        "Expecting two arguments: name (string) and amount (float).");
    return NULL;
  }
...
PyHarvesterEntity_increase_transport_priority(PyHarvesterEntityObject *self,
  ...
  if (!PyArg_ParseTuple(args, "s", &name)) {
    PyErr_SetString(PyExc_TypeError,
                    "Expecting a string arument (resource name).");
    return NULL;
  }
...
static PyObject *PyHarvesterEntity_unpickle(PyObject *cls, PyObject *args,
                                            PyObject *kwargs) {
  return s_call_super_method(
      "__unpickle__", (PyObject *)&PyHarvesterEntity_type, cls, args, kwargs);
}

static PyObject *
PyHarvesterEntity_get_total_carry(PyHarvesterEntityObject *self,
                                  void *closure) {
  if (self->super.ent->flags & ENTITY_FLAG_ZOMBIE) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Cannot get attribute of zombie entity.");
...
PyHarvesterEntity_get_transport_priority(PyHarvesterEntityObject *self,
  ...
  const char *names[64];
  int nres = G_Harvester_GetTransportPrio(self->super.ent->uid, ARR_SIZE(names),
                                          names);
...
static int PyHarvesterEntity_set_strategy(PyHarvesterEntityObject *self,
  ...
  if (!PyInt_Check(value) ||
    ...
    PyErr_SetString(PyExc_TypeError,
                    "Argument must be a tc.TRANSPORT_ enum value.");
    return -1;
  }
...
PyStorageSiteEntity_set_curr_amount(PyStorageSiteEntityObject *self,
  ...
  if (!PyArg_ParseTuple(args, "si", &name, &amount)) {
    PyErr_SetString(PyExc_TypeError,
                    "Expecting two argument: name (string) and amount (int).");
    return NULL;
  }

  if (!G_StorageSite_SetCurr(self->super.ent, name, amount)) {
    char buff[256];
    tc_snprintf(buff, sizeof(buff),
                "Unable to set amount (%d) for resource (%s).", amount, name);
...
PyStorageSiteEntity_get_storable(PyStorageSiteEntityObject *self,
  ...
  const char *names[64];
  int nres = G_StorageSite_GetStorableResources(self->super.ent->uid,
                                                ARR_SIZE(names), names);
...
static PyObject *PyStorageSiteEntity_pickle(PyStorageSiteEntityObject *self,
                                            PyObject *args, PyObject *kwargs) {
  return s_call_super_method("__pickle__",
                             (PyObject *)&PyStorageSiteEntity_type,
                             (PyObject *)self, args, kwargs);
}
...
static PyObject *PyStorageSiteEntity_unpickle(PyObject *cls, PyObject *args,
                                              PyObject *kwargs) {
  return s_call_super_method(
      "__unpickle__", (PyObject *)&PyStorageSiteEntity_type, cls, args, kwargs);
}
...
static PyObject *PyMovableEntity_unpickle(PyObject *cls, PyObject *args,
                                          PyObject *kwargs) {
  return s_call_super_method("__unpickle__", (PyObject *)&PyMovableEntity_type,
                             cls, args, kwargs);
}
...
static PyObject *s_obj_from_attr(const struct attr *attr) {
  switch (attr->type) {
  case TYPE_STRING:
    return Py_BuildValue("s", attr->val.as_string);
  case TYPE_FLOAT:
    return Py_BuildValue("f", attr->val.as_float);
  case TYPE_INT:
    return Py_BuildValue("i", attr->val.as_int);
  case TYPE_VEC3:
    return Py_BuildValue("(f,f,f)", attr->val.as_vec3.x, attr->val.as_vec3.y,
                         attr->val.as_vec3.z);
  case TYPE_QUAT:
    return Py_BuildValue("(f,f,f,f)", attr->val.as_quat.x, attr->val.as_quat.y,
                         attr->val.as_quat.z, attr->val.as_quat.w);
  case TYPE_BOOL:
    return Py_BuildValue("i", attr->val.as_bool);
  default:
    assert(0);
    return NULL;
  }
...
static PyObject *s_entity_from_atts(const char *path, const char *name,
  ...
  *end = '\0';
  ...
  if (anim) {
    ...
    if (k == kh_end(attr_table) ||
        !(idle_clip = s_obj_from_attr(&kh_value(attr_table, k)))) {
      Py_DECREF(args);
      Py_DECREF(kwargs);
      return NULL;
    }
...
static PyObject *s_new_custom_class(const char *name,
  ...
  if (!class) {
    char buff[256];
    tc_snprintf(buff, sizeof(buff), "Unable to find class %s", name);
    PyErr_SetString(PyExc_RuntimeError, buff);
    return NULL;
  }
  if (!PyType_Check(class)) {
    char buff[256];
    tc_snprintf(buff, sizeof(buff), "%s is not a 'type' instance", name);
    Py_DECREF(class);
    return NULL;
  }
...
void S_Entity_PyRegister(PyObject *module) {
  ...
  if (PyType_Ready(&PyCombatableEntity_type) < 0)
    Py_FatalError("Can't initialize tc.CombatableEntity type");
  Py_INCREF(&PyCombatableEntity_type);
  PyModule_AddObject(module, "CombatableEntity",
                     (PyObject *)&PyCombatableEntity_type);

  if (PyType_Ready(&PyBuildableEntity_type) < 0)
    Py_FatalError("Can't initialize tc.BuildableEntity type");
  Py_INCREF(&PyBuildableEntity_type);
  PyModule_AddObject(module, "BuildableEntity",
                     (PyObject *)&PyBuildableEntity_type);

  if (PyType_Ready(&PyBuilderEntity_type) < 0)
    Py_FatalError("Can't initialize tc.BuilderEntity type");
  Py_INCREF(&PyBuilderEntity_type);
  PyModule_AddObject(module, "BuilderEntity",
                     (PyObject *)&PyBuilderEntity_type);

  if (PyType_Ready(&PyResourceEntity_type) < 0)
    Py_FatalError("Can't initialize tc.ResourceEntity type");
  Py_INCREF(&PyResourceEntity_type);
  PyModule_AddObject(module, "ResourceEntity",
                     (PyObject *)&PyResourceEntity_type);

  if (PyType_Ready(&PyHarvesterEntity_type) < 0)
    Py_FatalError("Can't initialize tc.HarvesterEntity type");
  Py_INCREF(&PyHarvesterEntity_type);
  PyModule_AddObject(module, "HarvesterEntity",
                     (PyObject *)&PyHarvesterEntity_type);

  if (PyType_Ready(&PyStorageSiteEntity_type) < 0)
    Py_FatalError("Can't initialize tc.StorageSiteEntity type");
  Py_INCREF(&PyStorageSiteEntity_type);
  PyModule_AddObject(module, "StorageSiteEntity",
                     (PyObject *)&PyStorageSiteEntity_type);

  if (PyType_Ready(&PyMovableEntity_type) < 0)
    Py_FatalError("Can't initialize tc.MovableEntity type");
  Py_INCREF(&PyMovableEntity_type);
  PyModule_AddObject(module, "MovableEntity",
                     (PyObject *)&PyMovableEntity_type);
}
...
void S_Entity_Clear(void) { Py_CLEAR(s_loaded); }

void S_Entity_Shutdown(void) { kh_destroy(PyObject, s_uid_pyobj_table); }
...
script_opaque_t S_Entity_ObjFromAtts(const char *path, const char *name,
  ...
  /* If we could not make a custom class, fall back to instantiating a basic
   * entity */
  if (!ret) {
