...
#define TO_VEC2I(_tc_vec2t) ((struct nk_vec2i){_tc_vec2t.x, _tc_vec2t.y})
...
static int PyWindow_init(PyWindowObject *self, PyObject *args,
                         PyObject *kwargs);
static PyObject *PyWindow_layout_row_static(PyWindowObject *self,
                                            PyObject *args);
static PyObject *PyWindow_layout_row_dynamic(PyWindowObject *self,
                                             PyObject *args);
static PyObject *PyWindow_layout_row(PyWindowObject *self, PyObject *args);
static PyObject *PyWindow_layout_row_begin(PyWindowObject *self,
                                           PyObject *args);
...
static PyObject *PyWindow_label_colored_wrap(PyWindowObject *self,
                                             PyObject *args);
...
static PyObject *PyWindow_selectable_label(PyWindowObject *self,
                                           PyObject *args);
...
static PyObject *PyWindow_selectable_symbol_label(PyWindowObject *self,
                                                  PyObject *args);
...
static PyObject *PyWindow_file_browser(PyWindowObject *self, PyObject *args,
                                       PyObject *kwargs);
...
static PyObject *PyWindow_text_lines_width(PyWindowObject *self,
                                           PyObject *args);
...
static PyObject *PyWindow_pickle(PyWindowObject *self, PyObject *args,
                                 PyObject *kwargs);
static PyObject *PyWindow_unpickle(PyObject *cls, PyObject *args,
                                   PyObject *kwargs);
static PyObject *PyWindow_new(PyTypeObject *type, PyObject *args,
                              PyObject *kwds);
...
static int PyWindow_set_pos(PyWindowObject *self, PyObject *value,
                            void *closure);
static PyObject *PyWindow_get_size(PyWindowObject *self, void *closure);
static PyObject *PyWindow_get_header_height(PyWindowObject *self,
                                            void *closure);

static PyObject *PyWindow_get_border_color(PyWindowObject *self, void *closure);
static int PyWindow_set_border_color(PyWindowObject *self, PyObject *value,
                                     void *closure);
static PyObject *PyWindow_get_popup_border_color(PyWindowObject *self,
                                                 void *closure);
static int PyWindow_set_popup_border_color(PyWindowObject *self,
                                           PyObject *value, void *closure);
static PyObject *PyWindow_get_combo_border_color(PyWindowObject *self,
                                                 void *closure);
static int PyWindow_set_combo_border_color(PyWindowObject *self,
                                           PyObject *value, void *closure);
static PyObject *PyWindow_get_contextual_border_color(PyWindowObject *self,
                                                      void *closure);
static int PyWindow_set_contextual_border_color(PyWindowObject *self,
                                                PyObject *value, void *closure);
static PyObject *PyWindow_get_menu_border_color(PyWindowObject *self,
                                                void *closure);
static int PyWindow_set_menu_border_color(PyWindowObject *self, PyObject *value,
                                          void *closure);
static PyObject *PyWindow_get_group_border_color(PyWindowObject *self,
                                                 void *closure);
static int PyWindow_set_group_border_color(PyWindowObject *self,
                                           PyObject *value, void *closure);
static PyObject *PyWindow_get_tooltip_border_color(PyWindowObject *self,
                                                   void *closure);
static int PyWindow_set_tooltip_border_color(PyWindowObject *self,
                                             PyObject *value, void *closure);

static PyObject *PyWindow_get_border(PyWindowObject *self, void *closure);
static int PyWindow_set_border(PyWindowObject *self, PyObject *value,
                               void *closure);
static PyObject *PyWindow_get_combo_border(PyWindowObject *self, void *closure);
static int PyWindow_set_combo_border(PyWindowObject *self, PyObject *value,
                                     void *closure);
static PyObject *PyWindow_get_contextual_border(PyWindowObject *self,
                                                void *closure);
static int PyWindow_set_contextual_border(PyWindowObject *self, PyObject *value,
                                          void *closure);
static PyObject *PyWindow_get_menu_border(PyWindowObject *self, void *closure);
static int PyWindow_set_menu_border(PyWindowObject *self, PyObject *value,
                                    void *closure);
static PyObject *PyWindow_get_group_border(PyWindowObject *self, void *closure);
static int PyWindow_set_group_border(PyWindowObject *self, PyObject *value,
                                     void *closure);
static PyObject *PyWindow_get_tooltip_border(PyWindowObject *self,
                                             void *closure);
static int PyWindow_set_tooltip_border(PyWindowObject *self, PyObject *value,
                                       void *closure);
static PyObject *PyWindow_get_popup_border(PyWindowObject *self, void *closure);
static int PyWindow_set_popup_border(PyWindowObject *self, PyObject *value,
                                     void *closure);
static PyObject *PyWindow_get_min_row_height_padding(PyWindowObject *self,
                                                     void *closure);
static int PyWindow_set_min_row_height_padding(PyWindowObject *self,
                                               PyObject *value, void *closure);

static PyObject *PyWindow_get_rounding(PyWindowObject *self, void *closure);
static int PyWindow_set_rounding(PyWindowObject *self, PyObject *value,
                                 void *closure);
static PyObject *PyWindow_get_spacing(PyWindowObject *self, void *closure);
static int PyWindow_set_spacing(PyWindowObject *self, PyObject *value,
                                void *closure);
static PyObject *PyWindow_get_scrollbar_size(PyWindowObject *self,
                                             void *closure);
static int PyWindow_set_scrollbar_size(PyWindowObject *self, PyObject *value,
                                       void *closure);
static PyObject *PyWindow_get_min_size(PyWindowObject *self, void *closure);
static int PyWindow_set_min_size(PyWindowObject *self, PyObject *value,
                                 void *closure);

static PyObject *PyWindow_get_padding(PyWindowObject *self, void *closure);
static int PyWindow_set_padding(PyWindowObject *self, PyObject *value,
                                void *closure);
static PyObject *PyWindow_get_group_padding(PyWindowObject *self,
                                            void *closure);
static int PyWindow_set_group_padding(PyWindowObject *self, PyObject *value,
                                      void *closure);
static PyObject *PyWindow_get_popup_padding(PyWindowObject *self,
                                            void *closure);
static int PyWindow_set_popup_padding(PyWindowObject *self, PyObject *value,
                                      void *closure);
static PyObject *PyWindow_get_combo_padding(PyWindowObject *self,
                                            void *closure);
static int PyWindow_set_combo_padding(PyWindowObject *self, PyObject *value,
                                      void *closure);
static PyObject *PyWindow_get_contextual_padding(PyWindowObject *self,
                                                 void *closure);
static int PyWindow_set_contextual_padding(PyWindowObject *self,
                                           PyObject *value, void *closure);
static PyObject *PyWindow_get_menu_padding(PyWindowObject *self, void *closure);
static int PyWindow_set_menu_padding(PyWindowObject *self, PyObject *value,
                                     void *closure);
static PyObject *PyWindow_get_tooltip_padding(PyWindowObject *self,
                                              void *closure);
static int PyWindow_set_tooltip_padding(PyWindowObject *self, PyObject *value,
                                        void *closure);
...
static int PyWindow_set_interactive(PyWindowObject *self, PyObject *value,
                                    void *closure);
static PyObject *PyWindow_get_background(PyWindowObject *self, void *closure);
static int PyWindow_set_background(PyWindowObject *self, PyObject *value,
                                   void *closure);
static PyObject *PyWindow_get_fixed_background(PyWindowObject *self,
                                               void *closure);
static int PyWindow_set_fixed_background(PyWindowObject *self, PyObject *value,
                                         void *closure);
...
static PyMethodDef PyWindow_methods[] = {
    {"layout_row_static", (PyCFunction)PyWindow_layout_row_static, METH_VARARGS,
     "Add a row with a static layout."},

    {"layout_row_dynamic", (PyCFunction)PyWindow_layout_row_dynamic,
     METH_VARARGS, "Add a row with a dynamic layout."},

    {"layout_row_begin", (PyCFunction)PyWindow_layout_row_begin, METH_VARARGS,
     "Begin a new row to which widgets can be pushed."},

    {"layout_row_end", (PyCFunction)PyWindow_layout_row_end, METH_NOARGS,
     "End a row previously started with 'layout_row_begin'."},

    {"layout_row_push", (PyCFunction)PyWindow_layout_row_push, METH_VARARGS,
     "Add a widget to the currently active row. Note that this must be "
     "preceded by "
     "a call to 'layout_row_begin'."},

    {"label_colored", (PyCFunction)PyWindow_label_colored, METH_VARARGS,
     "Add a colored label layout with the specified alignment."},

    {"label_colored_wrap", (PyCFunction)PyWindow_label_colored_wrap,
     METH_VARARGS, "Add a colored label layout."},

    {"button_label", (PyCFunction)PyWindow_button_label,
     METH_VARARGS | METH_KEYWORDS, "Add a button with a label and action."},

    {"simple_chart", (PyCFunction)PyWindow_simple_chart, METH_VARARGS,
     "Add a chart with a single slot."},

    {"selectable_label", (PyCFunction)PyWindow_selectable_label, METH_VARARGS,
     "Adds a label that can be toggled to be selected with a mouse click. "
     "Returns the new state of the selectable label."},

    {"option_label", (PyCFunction)PyWindow_option_label, METH_VARARGS,
     "Radio button with the specified text. Returns if the radio button is "
     "selected."},

    {"edit_string", (PyCFunction)PyWindow_edit_string, METH_VARARGS,
     "Text field for getting string input from the user. Returns the current "
     "text."},

    {"edit_focus", (PyCFunction)PyWindow_edit_focus, METH_VARARGS,
     "Give focus to the next active text edit widget."},

    {"group", (PyCFunction)PyWindow_group, METH_VARARGS,
     "The window UI components pushed in the callable argument will be nested "
     "under a group."},

    {"popup", (PyCFunction)PyWindow_popup, METH_VARARGS,
     "The window UI components pushed in the callable argument will be "
     "presented in a popup."},

    {"popup_close", (PyCFunction)PyWindow_popup_close, METH_NOARGS,
     "Close the currently active popup window. Must only be called from poup "
     "context."},

    {"tree", (PyCFunction)PyWindow_tree, METH_VARARGS,
     "The window UI components pushed in the callable argument will be nested "
     "under a "
     "collapsable tree section."},

    {"tree_element", (PyCFunction)PyWindow_tree_element, METH_VARARGS,
     "The window UI components pushed in the callable argument will be nested "
     "under a "
     "collapsable non-root tree section."},

    {"selectable_symbol_label", (PyCFunction)PyWindow_selectable_symbol_label,
     METH_VARARGS, "Text label preceded by one of the tc.NK_SYMBOL_ symbols."},

    {"combo_box", (PyCFunction)PyWindow_combo_box, METH_VARARGS,
     "Present a combo box with a list of selectable options."},

    {"checkbox", (PyCFunction)PyWindow_checkbox, METH_VARARGS,
     "Checkbox which can be toggled. Returns True if checked."},

    {"color_picker", (PyCFunction)PyWindow_color_picker, METH_VARARGS,
     "Graphical color picker widget. Returns the selected color as an RGBA "
     "tuple."},

    {"image", (PyCFunction)PyWindow_image, METH_VARARGS,
     "Present an image at the specified path."},

    {"spacer", (PyCFunction)PyWindow_spacer, METH_VARARGS,
     "Empty widget to consume slots in a row."},

    {"property_float", (PyCFunction)PyWindow_property_float, METH_VARARGS,
     "Editable input field for floating-point properties."},

    {"property_int", (PyCFunction)PyWindow_property_int, METH_VARARGS,
     "Editable input field for integer properties."},

    {"file_browser", (PyCFunction)PyWindow_file_browser,
     METH_VARARGS | METH_KEYWORDS, "Present a file browser widget."},

    {"slider_float", (PyCFunction)PyWindow_slider_float, METH_VARARGS,
     "Present a slider widget with floating-point precision."},

    {"slider_int", (PyCFunction)PyWindow_slider_int, METH_VARARGS,
     "Present a slider widget with integer precision."},

    {"progress", (PyCFunction)PyWindow_progress, METH_VARARGS,
     "Present a progress bar widget with the current value, the maximum value "
     "and a 'modifiable' flag."},

    {"progress_text", (PyCFunction)PyWindow_progress_text, METH_VARARGS,
     "Like 'progress', but also taking a string and (RGBA) parameters to draw "
     "a label over the progress bar."},

    {"text_lines", (PyCFunction)PyWindow_text_lines, METH_VARARGS,
     "Returns the number of lines taken up by the specified text."},

    {"text_lines_width", (PyCFunction)PyWindow_text_lines_width, METH_VARARGS,
     "Returns the number of lines taken up by the specified text in a widget "
     "of the specified width."},

    {"show", (PyCFunction)PyWindow_show, METH_NOARGS,
     "Make the window visible."},

    {"hide", (PyCFunction)PyWindow_hide, METH_NOARGS,
     "Make the window invisible."},

    {"update", (PyCFunction)PyWindow_update, METH_NOARGS,
     "Handles layout and state changes of the window. Default implementation "
     "is empty. "
     "This method should be overridden by subclasses to customize the window "
     "look and behavior."},

    {"on_hide", (PyCFunction)PyWindow_on_hide, METH_VARARGS,
     "Callback that gets invoked when the user hides the window with the close "
     "button (or via an API call)."},

    {"on_minimize", (PyCFunction)PyWindow_on_minimize, METH_NOARGS,
     "Callback that gets invoked when the user minimizes the window with the "
     "minimize button."},

    {"on_maximize", (PyCFunction)PyWindow_on_maximize, METH_NOARGS,
     "Callback that gets invoked when the user maximizes the window with the "
     "maximize button."},

    {"__pickle__", (PyCFunction)PyWindow_pickle, METH_KEYWORDS,
     "Serialize a Permafrost Engine window to a string."},

    {"__unpickle__", (PyCFunction)PyWindow_unpickle,
     METH_VARARGS | METH_KEYWORDS | METH_CLASS,
     "Create a new tc.Window instance from a string earlier returned from a "
     "__pickle__ method."
...
static PyGetSetDef PyWindow_getset[] = {
    {"header", (getter)PyWindow_get_header, NULL,
     "An tc.UIHeaderStyle type for controlling the style parameters of the "
     "window header.",
     NULL},
    {"position", (getter)PyWindow_get_pos, (setter)PyWindow_set_pos,
     "A tuple of two integers specifying the X and Y position of the window.",
     NULL},
    {"size", (getter)PyWindow_get_size, NULL,
     "A tuple of two integers specifying the width and height dimentions of "
     "the window.",
     NULL},
    {"header_height", (getter)PyWindow_get_header_height, NULL,
     "A float specifying the height of the window header in pixels.", NULL},
    {"spacing", (getter)PyWindow_get_spacing, (setter)PyWindow_set_spacing,
     "An (X, Y) tuple of floats to control the spacing (between components) "
     "within a window.",
     NULL},
    {"padding", (getter)PyWindow_get_padding, (setter)PyWindow_set_padding,
     "An (X, Y) tuple of floats to control the padding (between border and "
     "content) of a window.",
     NULL},
    {"group_padding", (getter)PyWindow_get_group_padding,
     (setter)PyWindow_set_group_padding,
     "An (X, Y) tuple of floats to control the padding around a group in a "
     "window.",
     NULL},
    {"popup_padding", (getter)PyWindow_get_popup_padding,
     (setter)PyWindow_set_popup_padding,
     "An (X, Y) tuple of floats to control the padding in a popup window.",
     NULL},
    {"combo_padding", (getter)PyWindow_get_combo_padding,
     (setter)PyWindow_set_combo_padding,
     "An (X, Y) tuple of floats to control the padding around a combo section "
     "in a window.",
     NULL},
    {"contextual_padding", (getter)PyWindow_get_contextual_padding,
     (setter)PyWindow_set_contextual_padding,
     "An (X, Y) tuple of floats to control the padding around a contextual "
     "button.",
     NULL},
    {"menu_padding", (getter)PyWindow_get_menu_padding,
     (setter)PyWindow_set_menu_padding,
     "An (X, Y) tuple of floats to control the padding around a menu button in "
     "a window.",
     NULL},
    {"tooltip_padding", (getter)PyWindow_get_tooltip_padding,
     (setter)PyWindow_set_tooltip_padding,
     "An (X, Y) tuple of floats to control the padding in a tooltip window.",
     NULL},
    {"border_color", (getter)PyWindow_get_border_color,
     (setter)PyWindow_set_border_color,
     "An (R,G,B,A) tuple to control the border color of a window.", NULL},
    {"popup_border_color", (getter)PyWindow_get_popup_border_color,
     (setter)PyWindow_set_popup_border_color,
     "An (R,G,B,A) tuple to control the border color of window popups.", NULL},
    {"combo_border_color", (getter)PyWindow_get_combo_border_color,
     (setter)PyWindow_set_combo_border_color,
     "An (R,G,B,A) tuple to control the border color of window combo boxes.",
     NULL},
    {"contextual_border_color", (getter)PyWindow_get_contextual_border_color,
     (setter)PyWindow_set_contextual_border_color,
     "An (R,G,B,A) tuple to control the border color of window contextual "
     "panels.",
     NULL},
    {"menu_border_color", (getter)PyWindow_get_menu_border_color,
     (setter)PyWindow_set_menu_border_color,
     "An (R,G,B,A) tuple to control the border color of window menus.", NULL},
    {"group_border_color", (getter)PyWindow_get_group_border_color,
     (setter)PyWindow_set_group_border_color,
     "An (R,G,B,A) tuple to control the border color of window group panels.",
     NULL},
    {"tooltip_border_color", (getter)PyWindow_get_tooltip_border_color,
     (setter)PyWindow_set_tooltip_border_color,
     "An (R,G,B,A) tuple to control the border color of tooltip panels.", NULL},
    {"border", (getter)PyWindow_get_border, (setter)PyWindow_set_border,
     "A float to control the border width of a window.", NULL},
    {"combo_border", (getter)PyWindow_get_combo_border,
     (setter)PyWindow_set_combo_border,
     "A float to control the border width around a combo section.", NULL},
    {"contextual_border", (getter)PyWindow_get_contextual_border,
     (setter)PyWindow_set_contextual_border,
     "A float to control the border width around a contextual button.", NULL},
    {"menu_border", (getter)PyWindow_get_menu_border,
     (setter)PyWindow_set_menu_border,
     "A float to control the border width around a menu button.", NULL},
    {"group_border", (getter)PyWindow_get_group_border,
     (setter)PyWindow_set_group_border,
     "A float to control the border width around a group.", NULL},
    {"tooltip_border", (getter)PyWindow_get_tooltip_border,
     (setter)PyWindow_set_tooltip_border,
     "A float to control the border width around a tooltip window.", NULL},
    {"popup_border", (getter)PyWindow_get_popup_border,
     (setter)PyWindow_set_popup_border,
     "A float to control the border width around a popup window.", NULL},
    {"min_row_height_padding", (getter)PyWindow_get_min_row_height_padding,
     (setter)PyWindow_set_min_row_height_padding,
     "A float to control the minimum number of pixels of padding at the header "
     "and footer of a row..",
     NULL},
    {"scrollbar_size", (getter)PyWindow_get_scrollbar_size,
     (setter)PyWindow_set_scrollbar_size,
     "An (X, Y) tuple of floats to control the size of the scrollbar.", NULL},
    {"min_size", (getter)PyWindow_get_min_size, (setter)PyWindow_set_min_size,
     "An (X, Y) tuple of floats to control the minimum size of the window.",
     NULL},
    {"closed", (getter)PyWindow_get_closed, NULL,
     "A readonly bool indicating if this window is 'closed'.", NULL},
    {"hidden", (getter)PyWindow_get_hidden, NULL,
     "A readonly bool indicating if this window is 'hidden'.", NULL},
    {"interactive", (getter)PyWindow_get_interactive,
     (setter)PyWindow_set_interactive,
     "A read-write bool to enable or disable user interactivity for this "
     "window.",
     NULL},
    {"background", (getter)PyWindow_get_background,
     (setter)PyWindow_set_background,
     "An (R, G, B, A) tuple of floats specifying the background color for some "
     "panels "
     "such as the combo box popup.",
     NULL},
    {"fixed_background", (getter)PyWindow_get_fixed_background,
...
static PyTypeObject PyWindow_type = {
    PyVarObject_HEAD_INIT(NULL, 0) "tc.Window", /* tp_name */
...
static int PyWindow_init(PyWindowObject *self, PyObject *args,
  ...
  static char *kwlist[] = {
      "name",        "bounds",           "flags", "virtual_resolution",
      "resize_mask", "suspend_on_pause", NULL};

  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "s(iiii)i(ii)|ii", kwlist,
                                   &name, &rect.x, &rect.y, &rect.w, &rect.h,
                                   &flags, &vres[0], &vres[1], &resize_mask,
                                   &suspend_on_pause)) {
    PyErr_SetString(PyExc_TypeError,
                    "4 arguments expected: integer, tuple of 4 integers, "
                    "integer, and a tuple of 2 integers.");
    return -1;
  }
  ...
  tc_strlcpy(self->name, name, sizeof(self->name));
  self->rect = rect;
  self->flags = flags;
...
static PyObject *PyWindow_layout_row_push(PyWindowObject *self,
                                          PyObject *args) {
  float width;
...
static PyObject *PyWindow_label_colored(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "si(iii)", &text, &alignment, &r, &g, &b)) {
    PyErr_SetString(PyExc_TypeError, "3 arguments expected: a string, an "
                                     "integer and a tuple of 3 integers.");
    return NULL;
  }
...
static PyObject *PyWindow_label_colored_wrap(PyWindowObject *self,
  ...
  if (!PyArg_ParseTuple(args, "s(iii)", &text, &r, &g, &b)) {
    PyErr_SetString(
        PyExc_TypeError,
        "2 arguments expected: a string and a tuple of 3 integers.");
    return NULL;
  }
...
static PyObject *PyWindow_button_label(PyWindowObject *self, PyObject *args,
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "sO|Os", kwlist, &str,
                                   &callable, &cargs, &tooltip)) {
    PyErr_SetString(PyExc_TypeError,
                    "Arguments must be a string and an object. "
                    "Optionally, an argument to the callable can be provided, "
                    "as well as tooltip text.");
    return NULL;
  }
...
static PyObject *PyWindow_simple_chart(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "i(ii)O|O", &type, &min, &max, &list,
                        &on_click_handler)) {
    PyErr_SetString(PyExc_TypeError,
                    "3 arguments expected: an integer, a tuple of two "
                    "integers, and a list object. "
                    "Optionally, a callable taking exactly one integer index "
                    "argument (click handler) can additionally be supplied.");
    return NULL;
  }
...
static PyObject *PyWindow_selectable_label(PyWindowObject *self,
  ...
  if (!PyArg_ParseTuple(args, "sii", &text, &align_flags, &on)) {
    PyErr_SetString(PyExc_TypeError,
                    "Arguments must be a string and two integers.");
    return NULL;
  }
...
static PyObject *PyWindow_option_label(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "si", &text, &set)) {
    PyErr_SetString(PyExc_TypeError,
                    "Arguments must be a string and an integer.");
    return NULL;
  }
...
static PyObject *PyWindow_edit_string(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "is", &flags, &str)) {
    PyErr_SetString(PyExc_TypeError,
                    "Arguments must be an integer and a string.");
    return NULL;
  }
  ...
  nk_edit_string(s_nk_ctx, flags, textbuff, &len, sizeof(textbuff),
                 nk_filter_default);
  textbuff[len] = '\0';
...
static PyObject *PyWindow_group(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "siO|O", &name, &group_flags, &callable,
                        &cargs)) {
    PyErr_SetString(PyExc_TypeError,
                    "Arguments must be a string, an integer and an object. "
...
static PyObject *PyWindow_popup(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "sii(ffff)O|O", &name, &type, &popup_flags,
                        &rect.x, &rect.y, &rect.w, &rect.h, &callable,
                        &cargs)) {
    PyErr_SetString(
        PyExc_TypeError,
        "Arguments must be a string, an integer (type), an integer (flags), "
  ...
  if (type != NK_POPUP_STATIC && type != NK_POPUP_DYNAMIC) {
    PyErr_SetString(PyExc_TypeError,
                    "The type argument must be one of tc.NK_POPUP_STATIC or "
                    "tc.NK_POPUP_DYNAMIC.");
    return NULL;
  }
...
static PyObject *PyWindow_popup_close(PyWindowObject *self) {
  ...
  if (!(panel->type & NK_PANEL_SET_POPUP)) {
    ...
    PyErr_SetString(
        PyExc_RuntimeError,
        "The 'popup_close' method must only be called from poup context.");
    return NULL;
  }
...
static PyObject *PyWindow_tree(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "isiO|O", &type, &name, &state, &callable,
                        &cargs)) {
    PyErr_SetString(
        PyExc_TypeError,
        "Invalid arguments. Expecting: (type, name, state, callable, [args])");
    return NULL;
  }
  ...
  if (type != NK_TREE_TAB && type != NK_TREE_NODE) {
    PyErr_SetString(
        PyExc_TypeError,
        "First argument must be one of tc.NK_TREE_TAB or tc.NK_TREE_NODE.");
    return NULL;
  }
  ...
  if (state != NK_MINIMIZED && state != NK_MAXIMIZED) {
    PyErr_SetString(
        PyExc_TypeError,
        "Third argument must be one of tc.NK_MINIMIZED or tc.NK_MAXIMIZED.");
    return NULL;
  }
  ...
  if (cargs && !PyTuple_Check(cargs)) {
    PyErr_SetString(PyExc_TypeError,
                    "(Optional) fifth argument must be a tuple.");
    return NULL;
  }

  bool shown;
  if ((shown = nk_tree_push_hashed(s_nk_ctx, type, name, state, name,
                                   strlen(name), (uintptr_t)self))) {
    PyObject *ret = PyObject_CallObject(callable, cargs);
    Py_XDECREF(ret);
...
static PyObject *PyWindow_tree_element(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "isiOO|O", &type, &name, &state, &selected,
                        &callable, &cargs)) {
    PyErr_SetString(PyExc_TypeError,
                    "Invalida arguments. Expecting: (type, name, state, "
                    "selected, callable, [args])");
    return NULL;
  }
  ...
  if (cargs && !PyTuple_Check(cargs)) {
    PyErr_SetString(PyExc_TypeError,
                    "(Optional) sixth argument must be a tuple.");
    return NULL;
  }

  int sel = PyObject_IsTrue(selected);
  if (nk_tree_element_push_hashed(s_nk_ctx, type, name, state, &sel, name,
                                  strlen(name), (uintptr_t)self)) {
    PyObject *ret = PyObject_CallObject(callable, cargs);
    Py_XDECREF(ret);
    nk_tree_pop(s_nk_ctx);
...
static PyObject *PyWindow_selectable_symbol_label(PyWindowObject *self,
  ...
  if (!PyArg_ParseTuple(args, "isiO", &symbol, &title, &align, &selected)) {
    PyErr_SetString(
        PyExc_TypeError,
        "Invalida arguments. Expecting: (symbol, title, alignment, selected)");
    return NULL;
  }
  ...
  if (symbol < 0 || symbol >= NK_SYMBOL_MAX) {
    PyErr_SetString(
        PyExc_TypeError,
        "First argument must be one of the tc.NK_SYMBOL_ constants.");
    return NULL;
  }

  if (align != NK_TEXT_LEFT && align != NK_TEXT_RIGHT &&
      align != NK_TEXT_CENTERED) {
    PyErr_SetString(PyExc_TypeError,
                    "Third argument must be one of: tc.NK_TEXT_LEFT, "
                    "tc.NK_TEXT_CENTERED, tc.NK_TEXT_RIGHT.");
    return NULL;
  }
...
static PyObject *PyWindow_combo_box(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "Oii(ff)", &items_list, &selected_idx,
                        &item_height, &size.x, &size.y)) {
    PyErr_SetString(PyExc_TypeError, "Arguments must be an object, two "
                                     "integers, and a tuple of two floats.");
    return NULL;
  }
  ...
  for (int i = 0; i < num_items; i++) {
    ...
    if (!PyString_Check(str)) {
      PyErr_SetString(PyExc_TypeError,
                      "First argument list must only contain strings.");
      return NULL;
    }
  ...
  int ret =
      nk_combo(s_nk_ctx, labels, num_items, selected_idx, item_height, size);
...
static PyObject *PyWindow_color_picker(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "(iiii)(ff)", &color.r, &color.g, &color.b,
                        &color.a, &size.x, &size.y)) {
    PyErr_SetString(
        PyExc_TypeError,
        "Arguments must be a tuple of 4 ints and a tuple of 2 floats.");
    return NULL;
  }
...
static PyObject *PyWindow_property_float(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "sfffff", &name, &min, &max, &val, &step,
                        &drag_step)) {
    PyErr_SetString(
        PyExc_TypeError,
        "Expecting 6 arguments: name (string), min (float), max (float), "
...
static PyObject *PyWindow_property_int(PyObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "siiiif", &name, &min, &max, &val, &step,
                        &drag_step)) {
    PyErr_SetString(
        PyExc_TypeError,
        "Expecting 6 arguments: name (string), min (int), max (int), "
...
static PyObject *PyWindow_file_browser(PyWindowObject *self, PyObject *args,
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "ssOi", kwlist, &name,
                                   &directory, &selected, &flags)) {
    goto fail_args;
  }
  ...
  tc_strlcpy(state.name, name, sizeof(state.name));
  tc_strlcpy(state.directory, directory, sizeof(state.directory));
  state.flags = flags;

  if (selected == Py_None) {
    state.selected[0] = '\0';
  } else {
    tc_strlcpy(state.selected, PyString_AS_STRING(selected),
  ...
  return Py_BuildValue("{s:s,s:s,s:O,s:i}", "name", name, "directory",
                       state.directory, "selected", selected, "flags", flags);

fail_args:
  PyErr_SetString(PyExc_TypeError,
                  "4 arguments expected: name (string), directory (string), "
                  "selected (string or None), flags (int).");
  return NULL;
}
...
static PyObject *PyWindow_slider_float(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "ffff", &min, &max, &curr, &step)) {
    PyErr_SetString(PyExc_TypeError,
                    "Expecting 4 float arguments: min, max, curr, step");
    return NULL;
  }
...
static PyObject *PyWindow_slider_int(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "iiii", &min, &max, &curr, &step)) {
    PyErr_SetString(PyExc_TypeError,
                    "Expecting 4 int arguments: min, max, curr, step");
    return NULL;
  }
...
static PyObject *PyWindow_progress(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "iiO", &curr, &max, &mod)) {
    PyErr_SetString(PyExc_TypeError,
                    "Expecting 3 arguments: curr (int), max (int), "
...
static PyObject *PyWindow_progress_text(PyWindowObject *self, PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args, "iiOs(iiii)", &curr, &max, &mod, &str, &r, &g, &b,
                        &a)) {
    PyErr_SetString(PyExc_TypeError,
                    "Expecting 5 arguments: curr (int), max (int), "
                    "modifiable (bool expression), text (string), color (RGBA) "
                    "integer tuple.");
    return NULL;
  }
...
static PyObject *PyWindow_text_lines_width(PyWindowObject *self,
  ...
  if (!PyArg_ParseTuple(args, "si", &str, &width)) {
    PyErr_SetString(
        PyExc_TypeError,
        "Expecting a string argument (text) and an integer argument (width).");
    return NULL;
  }
...
static PyObject *PyWindow_update(PyWindowObject *self) { Py_RETURN_NONE; }

static PyObject *PyWindow_on_hide(PyWindowObject *self, PyObject *args) {
  Py_RETURN_NONE;
}

static PyObject *PyWindow_on_minimize(PyWindowObject *self) { Py_RETURN_NONE; }

static PyObject *PyWindow_on_maximize(PyWindowObject *self) { Py_RETURN_NONE; }
...
static PyObject *PyWindow_pickle(PyWindowObject *self, PyObject *args,
  ...
  PyObject *rect = Py_BuildValue("(iiii)", self->rect.x, self->rect.y,
  ...
  PyObject *virt_res =
      Py_BuildValue("(ii)", self->virt_res.x, self->virt_res.y);
...
static PyObject *PyWindow_unpickle(PyObject *cls, PyObject *args,
  ...
  if (!name || !rect || !flags || !resize_mask || !sop || !hide || !virt_res) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Could not unpickle internal state of tc.Window instance");
    goto fail_unpickle;
  }
  ...
  PyObject *win_args =
      Py_BuildValue("(OOOOOO)", name, rect, flags, virt_res, resize_mask, sop);
  PyWindowObject *winobj = (PyWindowObject *)heap_subtype->tp_new(
      (struct _typeobject *)cls, win_args, NULL);
  ...
  if (!PyArg_ParseTuple(win_args, "s(iiii)i(ii)|ii", &namestr, &winobj->rect.x,
                        &winobj->rect.y, &winobj->rect.w, &winobj->rect.h,
                        &winobj->flags, &winobj->virt_res.x,
                        &winobj->virt_res.y, &winobj->resize_mask, &isop)) {
    goto fail_window;
  }
  tc_strlcpy(winobj->name, namestr, sizeof(winobj->name));
  ...
  if (!S_UI_Style_LoadWindow(stream, &winobj->style)) {
    PyErr_SetString(PyExc_RuntimeError,
                    "Could not unpickle style state of tc.Window instance");
    goto fail_window;
  }
...
static PyObject *PyWindow_get_header_height(PyWindowObject *self,
  ...
  return Py_BuildValue("i",
                       (int)S_UIHeaderGetHeight(self->header_style, s_nk_ctx));
}
...
static PyObject *PyWindow_get_group_padding(PyWindowObject *self,
                                            void *closure) {
  return Py_BuildValue("(f, f)", self->style.group_padding.x,
...
static PyObject *PyWindow_get_combo_padding(PyWindowObject *self,
                                            void *closure) {
  return Py_BuildValue("(f, f)", self->style.combo_padding.x,
                       self->style.combo_padding.y);
}

static PyObject *PyWindow_get_popup_padding(PyWindowObject *self,
                                            void *closure) {
  return Py_BuildValue("(f, f)", self->style.popup_padding.x,
...
static PyObject *PyWindow_get_contextual_padding(PyWindowObject *self,
                                                 void *closure) {
  return Py_BuildValue("(f, f)", self->style.contextual_padding.x,
...
static PyObject *PyWindow_get_menu_padding(PyWindowObject *self,
                                           void *closure) {
  return Py_BuildValue("(f, f)", self->style.menu_padding.x,
...
static PyObject *PyWindow_get_tooltip_padding(PyWindowObject *self,
                                              void *closure) {
  return Py_BuildValue("(f, f)", self->style.tooltip_padding.x,
...
static PyObject *PyWindow_get_border_color(PyWindowObject *self,
                                           void *closure) {
  return Py_BuildValue("iiii", self->style.border_color.r,
...
static int PyWindow_set_border_color(PyWindowObject *self, PyObject *value,
  ...
  if (!PyArg_ParseTuple(value, "iiii", &r, &g, &b, &a)) {
    PyErr_SetString(PyExc_TypeError,
                    "Value must be a tuple of 4 integers (0-255).");
    return -1;
  }
...
static PyObject *PyWindow_get_popup_border_color(PyWindowObject *self,
                                                 void *closure) {
  return Py_BuildValue("iiii", self->style.popup_border_color.r,
...
static PyObject *PyWindow_get_combo_border_color(PyWindowObject *self,
                                                 void *closure) {
  return Py_BuildValue("iiii", self->style.combo_border_color.r,
...
static PyObject *PyWindow_get_contextual_border_color(PyWindowObject *self,
                                                      void *closure) {
  return Py_BuildValue("iiii", self->style.contextual_border_color.r,
...
static PyObject *PyWindow_get_menu_border_color(PyWindowObject *self,
  ...
  return Py_BuildValue(
      "iiii", self->style.menu_border_color.r, self->style.menu_border_color.g,
      self->style.menu_border_color.b, self->style.menu_border_color.a);
}
...
static PyObject *PyWindow_get_group_border_color(PyWindowObject *self,
                                                 void *closure) {
  return Py_BuildValue("iiii", self->style.group_border_color.r,
...
static PyObject *PyWindow_get_tooltip_border_color(PyWindowObject *self,
                                                   void *closure) {
  return Py_BuildValue("iiii", self->style.tooltip_border_color.r,
...
static PyObject *PyWindow_get_group_border(PyWindowObject *self,
                                           void *closure) {
...
static PyObject *PyWindow_get_combo_border(PyWindowObject *self,
                                           void *closure) {
...
static PyObject *PyWindow_get_popup_border(PyWindowObject *self,
                                           void *closure) {
...
static PyObject *PyWindow_get_min_size(PyWindowObject *self, void *closure) {
  return Py_BuildValue("(f, f)", self->style.min_size.x,
...
static PyObject *PyWindow_get_background(PyWindowObject *self, void *closure) {
  return Py_BuildValue("iiii", self->style.background.r,
                       self->style.background.g, self->style.background.b,
...
static int PyWindow_set_fixed_background(PyWindowObject *self, PyObject *value,
  ...
  if (PyTuple_Check(value)) {
    ...
    if (!PyArg_ParseTuple(value, "iiii", &r, &g, &b, &a)) {
      PyErr_SetString(
          PyExc_TypeError,
          "Value must be a tuple of 4 integers (0-255) or a path string.");
      return -1;
    }

    struct nk_color bg = (struct nk_color){r, g, b, a};
    self->style.fixed_background =
        (struct nk_style_item){.type = NK_STYLE_ITEM_COLOR, .data.color = bg};

  } else if (PyString_Check(value)) {

    self->style.fixed_background =
        (struct nk_style_item){.type = NK_STYLE_ITEM_TEXPATH};
    tc_strlcpy(self->style.fixed_background.data.texpath,
...
static void call_registered_arg(PyObject *obj, char *method_name,
                                PyObject *arg) {
...
static void active_windows_update(void *user, void *event) {
  ...
  for (int i = 0; i < vec_size(&s_active_windows); i++) {
    ...
    struct nk_vec2i adj_vres =
        TO_VEC2I(UI_ArAdjustedVRes(TO_VEC2T(win->virt_res)));
    struct rect adj_bounds =
        UI_BoundsForAspectRatio(win->rect, TO_VEC2T(win->virt_res),
                                TO_VEC2T(adj_vres), win->resize_mask);
    ...
    win->rect =
        UI_BoundsForAspectRatio(adj_bounds, TO_VEC2T(adj_vres),
...
bool S_UI_MouseOverWindow(int mouse_x, int mouse_y) {
  ...
  for (int i = 0; i < vec_size(&s_active_windows); i++) {
    ...
    struct rect adj_bounds = UI_BoundsForAspectRatio(
        win->rect, TO_VEC2T(win->virt_res),
        UI_ArAdjustedVRes(TO_VEC2T(win->virt_res)), win->resize_mask);
    struct nk_vec2 visible_size = {adj_bounds.w, adj_bounds.h};

    if (win->flags & NK_WINDOW_HIDDEN || win->flags & NK_WINDOW_CLOSED) {
      continue;
    }

    int vmouse_x =
        (float)mouse_x / w * UI_ArAdjustedVRes(TO_VEC2T(win->virt_res)).x;
    int vmouse_y =
        (float)mouse_y / h * UI_ArAdjustedVRes(TO_VEC2T(win->virt_res)).y;
    ...
    if (C_PointInsideRect2D(
            (vec2_t){vmouse_x, vmouse_y}, (vec2_t){adj_bounds.x, adj_bounds.y},
            (vec2_t){adj_bounds.x + visible_size.x, adj_bounds.y},
            (vec2_t){adj_bounds.x + visible_size.x,
                     adj_bounds.y + visible_size.y},
